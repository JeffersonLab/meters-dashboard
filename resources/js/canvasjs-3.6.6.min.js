...
this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),I(v,"mouseout",function(){n||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),I(v,"click",function(){h.exportChart({format:"png",fileName:h.exportFileName});sa(h._dropdownMenu)},h.allDOMEventHandlers,!0))}function $a(h,n,v){h*=fa;n*=fa;h=v.getImageData(h,n,2,2).data;n=!0;for(v=0;4>v;v++)if(h[v]!==h[v+4]|h[v]!==h[v+8]|h[v]!==h[v+12]){n=!1;break}return n?
h[0]<<16|h[1]<<8|h[2]:0}function ja(h,n,v){return h in n?n[h]:v[h]}function Ma(h,n,v){if(w&&ab){var s=h.getContext("2d");Na=s.webkitBackingStorePixelRatio||s.mozBackingStorePixelRatio||s.msBackingStorePixelRatio||s.oBackingStorePixelRatio||s.backingStorePixelRatio||1;fa=Sa/Na;h.width=n*fa;h.height=v*fa;Sa!==Na&&(h.style.width=n+"px",h.style.height=v+"px",s.scale(fa,fa))}else h.width=n,h.height=v}function ib(h){if(!jb){var n=!1,v=!1;"undefined"===typeof va.Chart.creditHref?(h.creditHref=Y("iuuqr;..b`ow`rkr/bnl."),
h.creditText=Y("B`ow`rKR/bnl")):(n=h.updateOption("creditText"),v=h.updateOption("creditHref"));if(h.creditHref&&h.creditText){h._creditLink||(h._creditLink=document.createElement("a"),h._creditLink.setAttribute("class","canvasjs-chart-credit"),h._creditLink.setAttribute("title","JavaScript Charts"),J(h._creditLink,{outline:"none",margin:"0px",position:"absolute",right:"2px",top:h.height-14+"px",color:"dimgrey",textDecoration:"none",fontSize:"11px",fontFamily:"Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"}),
h._creditLink.setAttribute("tabIndex",-1),h._creditLink.setAttribute("target","_blank"));if(0===h.renderCount||n||v)h._creditLink.setAttribute("href",h.creditHref),h._creditLink.innerHTML=h.creditText;h._creditLink&&h.creditHref&&h.creditText?(h._creditLink.parentElement||h._canvasJSContainer.appendChild(h._creditLink),h._creditLink.style.top=h.height-14+"px"):h._creditLink.parentElement&&h._canvasJSContainer.removeChild(h._creditLink)}}}function qa(h,n){Ha&&(this.canvasCount|=0,window.console.log(++this.canvasCount));
...
v&&(n.setAttribute("state",v),n.setAttribute("type","button"),J(n,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),n.setAttribute("title",h._cultureInfo[v+"Text"]),n.innerHTML="<img src='"+kb[v].image+"' alt='"+h._cultureInfo[v+"Text"]+"' />",J(n.childNodes[0],{height:"95%",pointerEvents:"none"}))}function La(){for(var h=null,n=0;n<arguments.length;n++)h=arguments[n],h.style&&(h.style.display="inline")}function sa(){for(var h=
null,n=0;n<arguments.length;n++)(h=arguments[n])&&h.style&&(h.style.display="none")}function Ta(h,n,v,s,w){if(null===h||"undefined"===typeof h)return"undefined"===typeof v?n:v;h=parseFloat(h.toString())*(0<=h.toString().indexOf("%")?n/100:1);"undefined"!==typeof s&&(h=Math.min(s,h),"undefined"!==typeof w&&(h=Math.max(w,h)));return!isNaN(h)&&h<=n&&0<=h?h:"undefined"===typeof v?n:v}function V(h,n,v,w,x){this._defaultsKey=h;this._themeOptionsKey=n;this._index=w;this.parent=x;this._eventListeners=[];
...
typeof w&&(w=0);this._padding=w;this._x1=h;this._y1=n;this._x2=v;this._y2=s;this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding}function ha(h,n){ha.base.constructor.call(this,"TextBlock",null,n,null,null);this.ctx=h;this._isDirty=!0;this._wrappedText=null;this._initialize()}function Ua(h,n){Ua.base.constructor.call(this,"Toolbar","toolbar",n,null,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="toolbar"}function xa(h,n){xa.base.constructor.call(this,
...
[]}function Ja(h){var n;h&&Ka[h]&&(n=Ka[h]);Ja.base.constructor.call(this,"CultureInfo",null,n,null,null)}var Ha=!1,Ga={},w=!!document.createElement("canvas").getContext,va={Chart:{width:500,height:400,zoomEnabled:!1,zoomType:"x",backgroundColor:"white",theme:"light1",animationEnabled:!1,animationDuration:1200,dataPointWidth:null,dataPointMinWidth:null,dataPointMaxWidth:null,colorSet:"colorSet1",culture:"en",creditHref:"",creditText:"CanvasJS",interactivityEnabled:!0,exportEnabled:!1,exportFileName:"Chart",
...
K,U,W,ca,ga;U="#333333";W="#000000";K="#666666";ga=ca="#000000";var ba=20,E=14,Wa={colorSet:"colorSet1",backgroundColor:"#FFFFFF",title:{fontFamily:Ea,fontSize:32,fontColor:U,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Ea,fontSize:E,fontColor:U,fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:x,indexLabelFontSize:E,indexLabelFontColor:U,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:U,
titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:W,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",
spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:U,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:W,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,
labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:U,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:W,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,
labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:U,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,
labelFontColor:W,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,
lineDashType:"solid"}}],legend:{fontFamily:x,fontSize:14,fontColor:U,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:x,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1},toolbar:{itemBackgroundColor:"white",itemBackgroundColorOnHover:"#2196f3",buttonBorderColor:"#2196f3",buttonBorderThickness:1,fontColor:"black",fontColorOnHover:"white"}};W=U="#F5F5F5";K="#FFFFFF";ca="#40BAF1";ga="#F5F5F5";var ba=20,E=14,bb={colorSet:"colorSet2",title:{fontFamily:x,
fontSize:33,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"top",margin:5},subtitles:[{fontFamily:x,fontSize:E,fontColor:"#3A3A3A",fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:x,indexLabelFontSize:E,indexLabelFontColor:"#666666",indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",
...
lineDashType:"solid"}}],axisX2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,
labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",
stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:"#666666",titleFontWeight:"normal",
...
ca="#40BAF1";ga="#F5F5F5";ba=20;E=14;Ea={colorSet:"colorSet12",backgroundColor:"#2A2A2A",title:{fontFamily:Ea,fontSize:32,fontColor:U,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Ea,fontSize:E,fontColor:U,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:x,indexLabelFontSize:E,
indexLabelFontColor:W,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:W,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:W,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,
labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:W,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:W,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,
labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:W,titleFontWeight:"normal",labelFontFamily:x,
labelFontSize:E,labelFontColor:W,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",
lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:W,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:W,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",
labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:x,fontSize:14,fontColor:U,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:x,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:W,backgroundColor:"rgba(0, 0, 0, .7)"}};K="#FFFFFF";W=U="#FAFAFA";ca="#40BAF1";ga="#F5F5F5";
var ba=20,E=14,cb={light1:Wa,light2:bb,dark1:Ea,dark2:{colorSet:"colorSet2",backgroundColor:"#32373A",title:{fontFamily:x,fontSize:32,fontColor:U,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:x,fontSize:E,fontColor:U,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:x,
indexLabelFontSize:E,indexLabelFontColor:W,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:W,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:W,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,
labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:W,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:W,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:x,
labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:W,titleFontWeight:"normal",labelFontFamily:x,
labelFontSize:E,labelFontColor:W,labelFontWeight:"normal",lineThickness:0,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",
lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:x,titleFontSize:ba,titleFontColor:W,titleFontWeight:"normal",labelFontFamily:x,labelFontSize:E,labelFontColor:W,labelFontWeight:"normal",lineThickness:0,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:x,labelFontSize:E,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:x,labelFontSize:E,labelFontColor:"#000000",
labelFontWeight:"normal",labelBackgroundColor:ga,color:ca,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:x,fontSize:14,fontColor:U,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:x,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:W,backgroundColor:"rgba(0, 0, 0, .7)"}},theme1:Wa,theme2:bb,theme3:Wa},S={numberDuration:1,
...
Za={},oa=null,lb=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},wa=function(h){h.width=1;h.height=1;h.getContext("2d")&&h.getContext("2d").clearRect(0,0,1,1)},mb=function(h,n,v){n=Math.min(this.width,this.height);return Math.max("theme4"===this.theme?0:300<=n?12:11,Math.round(n*(h/400)))},za=function(){var h=/D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,
n="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),v="Sun Mon Tue Wed Thu Fri Sat".split(" "),s="January February March April May June July August September October November December".split(" "),w="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),x=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,F=/[^-+\dA-Z]/g;return function(E,N,P){var K=P?P.days:n,Q=P?P.months:s,I=P?P.shortDays:
v,S=P?P.shortMonths:w;P="";var J=!1;E=E&&E.getTime?E:E?new Date(E):new Date;if(isNaN(E))throw SyntaxError("invalid date");"UTC:"===N.slice(0,4)&&(N=N.slice(4),J=!0);P=J?"getUTC":"get";var V=E[P+"Date"](),M=E[P+"Day"](),Z=E[P+"Month"](),a=E[P+"FullYear"](),d=E[P+"Hours"](),c=E[P+"Minutes"](),b=E[P+"Seconds"](),e=E[P+"Milliseconds"](),f=J?0:E.getTimezoneOffset();return P=N.replace(h,function(l){switch(l){case "D":return V;case "DD":return X(V,2);case "DDD":return I[M];case "DDDD":return K[M];case "M":return Z+
1;case "MM":return X(Z+1,2);case "MMM":return S[Z];case "MMMM":return Q[Z];case "Y":return parseInt(String(a).slice(-2));case "YY":return X(String(a).slice(-2),2);case "YYY":return X(String(a).slice(-3),3);case "YYYY":return X(a,4);case "h":return d%12||12;case "hh":return X(d%12||12,2);case "H":return d;case "HH":return X(d,2);case "m":return c;case "mm":return X(c,2);case "s":return b;case "ss":return X(b,2);case "f":return X(String(e),3).slice(0,1);case "ff":return X(String(e),3).slice(0,2);case "fff":return X(String(e),
3).slice(0,3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return J?"UTC":(String(E).match(x)||[""]).pop().replace(F,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+X(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+X(Math.floor(Math.abs(f)/60),2)+X(Math.abs(f)%60,2);default:return l.slice(1,l.length-1)}})}}(),da=function(h,n,v){if(null===h)return"";if(!isFinite(h))return h;
h=Number(h);var s=0>h?!0:!1;s&&(h*=-1);var w=v?v.decimalSeparator:".",x=v?v.digitGroupSeparator:",",F="";n=String(n);var F=1,E=v="",N=-1,P=[],K=[],Q=0,I=0,S=0,J=!1,V=0,E=n.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);n=null;for(var M=0;E&&M<E.length;M++)if(n=E[M],"."===n&&0>N)N=M;else{if("%"===n)F*=100;else if("\u2030"===n){F*=1E3;continue}else if(","===n[0]&&"."===n[n.length-1]){F/=Math.pow(1E3,n.length-1);N=M+n.length-1;continue}else"E"!==n[0]&&"e"!==n[0]||"0"!==n[n.length-1]||(J=!0);
0>N?(P.push(n),"#"===n||"0"===n?Q++:","===n&&S++):(K.push(n),"#"!==n&&"0"!==n||I++)}J&&(n=Math.floor(h),E=-Math.floor(Math.log(h)/Math.LN10+1),V=0===h?0:0===n?-(Q+E):String(n).length-Q,F/=Math.pow(10,V));0>N&&(N=M);F=(h*F).toFixed(I);n=F.split(".");F=(n[0]+"").split("");h=(n[1]+"").split("");F&&"0"===F[0]&&F.shift();for(J=E=M=I=N=0;0<P.length;)if(n=P.pop(),"#"===n||"0"===n)if(N++,N===Q){var Z=F,F=[];if("0"===n)for(n=Q-I-(Z?Z.length:0);0<n;)Z.unshift("0"),n--;for(;0<Z.length;)v=Z.pop()+v,J++,0===J%
E&&(M===S&&0<Z.length)&&(v=x+v)}else 0<F.length?(v=F.pop()+v,I++,J++):"0"===n&&(v="0"+v,I++,J++),0===J%E&&(M===S&&0<F.length)&&(v=x+v);else"E"!==n[0]&&"e"!==n[0]||"0"!==n[n.length-1]||!/[eE][+-]*[0]+/.test(n)?","===n?(M++,E=J,J=0,0<F.length&&(v=x+v)):v=1<n.length&&('"'===n[0]&&'"'===n[n.length-1]||"'"===n[0]&&"'"===n[n.length-1])?n.slice(1,n.length-1)+v:n+v:(n=0>V?n.replace("+","").replace("-",""):n.replace("-",""),v+=n.replace(/[0]+/,function(a){return X(V,a.length)}));x="";for(P=!1;0<K.length;)n=
K.shift(),"#"===n||"0"===n?0<h.length&&0!==Number(h.join(""))?(x+=h.shift(),P=!0):"0"===n&&(x+="0",P=!0):1<n.length&&('"'===n[0]&&'"'===n[n.length-1]||"'"===n[0]&&"'"===n[n.length-1])?x+=n.slice(1,n.length-1):"E"!==n[0]&&"e"!==n[0]||"0"!==n[n.length-1]||!/[eE][+-]*[0]+/.test(n)?x+=n:(n=0>V?n.replace("+","").replace("-",""):n.replace("-",""),x+=n.replace(/[0]+/,function(a){return X(V,a.length)}));v+=(P?w:"")+x;return s?"-"+v:v},Oa=function(h){var n=0,v=0;h=h||window.event;h.offsetX||0===h.offsetX?
(n=h.offsetX,v=h.offsetY):h.layerX||0==h.layerX?(n=h.layerX,v=h.layerY):(n=h.pageX-h.target.offsetLeft,v=h.pageY-h.target.offsetTop);return{x:n,y:v}},ab=!0,Sa=window.devicePixelRatio||1,Na=1,fa=ab?Sa/Na:1,aa=function(h,n,v,s,w,x,F,E,N,P,Q,K,J){"undefined"===typeof J&&(J=1);F=F||0;E=E||"black";var I=15<s-n&&15<w-v?8:0.35*Math.min(s-n,w-v);h.beginPath();h.moveTo(n,v);h.save();h.fillStyle=x;h.globalAlpha=J;h.fillRect(n,v,s-n,w-v);h.globalAlpha=1;0<F&&(J=0===F%2?0:0.5,h.beginPath(),h.lineWidth=F,h.strokeStyle=
E,h.moveTo(n,v),h.rect(n-J,v-J,s-n+2*J,w-v+2*J),h.stroke());h.restore();!0===N&&(h.save(),h.beginPath(),h.moveTo(n,v),h.lineTo(n+I,v+I),h.lineTo(s-I,v+I),h.lineTo(s,v),h.closePath(),F=h.createLinearGradient((s+n)/2,v+I,(s+n)/2,v),F.addColorStop(0,x),F.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=F,h.fill(),h.restore());!0===P&&(h.save(),h.beginPath(),h.moveTo(n,w),h.lineTo(n+I,w-I),h.lineTo(s-I,w-I),h.lineTo(s,w),h.closePath(),F=h.createLinearGradient((s+n)/2,w-I,(s+n)/2,w),F.addColorStop(0,
x),F.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=F,h.fill(),h.restore());!0===Q&&(h.save(),h.beginPath(),h.moveTo(n,v),h.lineTo(n+I,v+I),h.lineTo(n+I,w-I),h.lineTo(n,w),h.closePath(),F=h.createLinearGradient(n+I,(w+v)/2,n,(w+v)/2),F.addColorStop(0,x),F.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=F,h.fill(),h.restore());!0===K&&(h.save(),h.beginPath(),h.moveTo(s,v),h.lineTo(s-I,v+I),h.lineTo(s-I,w-I),h.lineTo(s,w),F=h.createLinearGradient(s-I,(w+v)/2,s,(w+v)/2),F.addColorStop(0,
x),F.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=F,F.addColorStop(0,x),F.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=F,h.fill(),h.closePath(),h.restore())},Y=function(h){for(var n="",s=0;s<h.length;s++)n+=String.fromCharCode(Math.ceil(h.length/57/5)^h.charCodeAt(s));return n},jb=window&&(window[Y("mnb`uhno")]&&window[Y("mnb`uhno")].href&&window[Y("mnb`uhno")].href.indexOf&&(-1!==window[Y("mnb`uhno")].href.indexOf(Y("b`ow`rkr/bnl"))||-1!==window[Y("mnb`uhno")].href.indexOf(Y("gdonqhy/bnl"))||
-1!==window[Y("mnb`uhno")].href.indexOf(Y("gheemd"))))&&-1===window[Y("mnb`uhno")].href.indexOf(Y("gheemd")),kb={reset:{image:"data:image/png;base64,"},
...
V.prototype.setOptions=function(h,n){if(va[this._defaultsKey]){var s=va[this._defaultsKey],w;for(w in s)"publicProperties"!==w&&s.hasOwnProperty(w)&&(this[w]=h&&w in h?h[w]:n&&w in n?n[w]:s[w])}else Ha&&window.console&&console.log("defaults not set")};V.prototype.get=function(h){var n=va[this._defaultsKey];if("options"===h)return this.options&&this.options._isPlaceholder?null:this.options;if(n.hasOwnProperty(h)||n.publicProperties&&n.publicProperties.hasOwnProperty(h))return this[h];window.console&&
...
n=s):n=void 0,h[n]=this.options};V.prototype.remove=function(h){h="undefined"===typeof h?!0:h;if(this.isOptionsInArray){var n=this.parent.options[this.optionsName];Ca(n);var s=n.indexOf(this.options);0<=s&&n.splice(s,1)}else delete this.parent.options[this.optionsName];h&&(this.stockChart||this.chart||this).render()};V.prototype.updateOption=function(h){!va[this._defaultsKey]&&(Ha&&window.console)&&console.log("defaults not set");var n=va[this._defaultsKey],w={},x=this[h],E=this._themeOptionsKey,
I=this._index;this.theme&&s(this.parent)&&s(E)&&s(I)?w=s(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[E])&&(null===I?w=this.parent.themeOptions[E]:0<this.parent.themeOptions[E].length&&(w=Math.min(this.parent.themeOptions[E].length-1,I),w=this.parent.themeOptions[E][w]));this.themeOptions=w;h in n&&(x=h in this.options?this.options[h]:w&&h in w?w[h]:n[h]);if(x===this[h])return!1;this[h]=
...
this.measureText(this.ctx);this.ctx.translate(this.x,this.y+s);"middle"===this.textBaseline&&(s=-this._lineHeight/2);this.ctx.font=this._getFontString();this.ctx.rotate(Math.PI/180*this.angle);var w=0,x=this.topPadding,E=null;this.ctx.roundRect||Ba(this.ctx);(0<this.borderThickness&&this.borderColor||this.backgroundColor)&&this.ctx.roundRect(0,s,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);this.ctx.fillStyle=this.fontColor;for(s=0;s<this._wrappedText.lines.length;s++){E=
this._wrappedText.lines[s];if("right"===this.horizontalAlign||"right"===this.textAlign)w=this.width-E.width-this.rightPadding;else if("left"===this.horizontalAlign||"left"===this.textAlign)w=this.leftPadding;else if("center"===this.horizontalAlign||"center"===this.textAlign)w=(this.width-(this.leftPadding+this.rightPadding))/2-E.width/2+this.leftPadding;this.ctx.fillText(E.text,w,x);x+=E.height}this.ctx.font=n;h&&this.ctx.restore()}};ha.prototype.setText=function(h){this.text=h;this._isDirty=!0;this._wrappedText=
null};ha.prototype.measureText=function(){this._lineHeight=Ya(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ha.prototype._getLineWithWidth=function(h,n,s){h=String(h);if(!h)return{text:"",width:0};var w=s=0,x=h.length-1,E=Infinity;for(this.ctx.font=this._getFontString();w<=x;){var E=Math.floor((w+x)/2),F=h.substr(0,E+1);s=this.ctx.measureText(F).width;
if(s<n)w=E+1;else if(s>n)x=E-1;else break}s>n&&1<F.length&&(F=F.substr(0,F.length-1),s=this.ctx.measureText(F).width);n=!0;if(F.length===h.length||" "===h[F.length])n=!1;n&&(h=F.split(" "),1<h.length&&h.pop(),F=h.join(" "),s=this.ctx.measureText(F).width);return{text:F,width:s}};ha.prototype._wrapText=function(){var h=new String(Fa(String(this.text))),n=[],s=this.ctx.font,w=0,x=0;this.ctx.font=this._getFontString();if(0===this.frontSize)x=w=0;else for(;0<h.length;){var E=this.maxHeight-(this.topPadding+
this.bottomPadding),F=this._getLineWithWidth(h,this.maxWidth-(this.leftPadding+this.rightPadding),!1);F.height=this._lineHeight;n.push(F);var I=x,x=Math.max(x,F.width),w=w+F.height,h=Fa(h.slice(F.text.length,h.length));E&&w>E&&(F=n.pop(),w-=F.height,x=I)}this._wrappedText={lines:n,width:x,height:w};this.width=x+(this.leftPadding+this.rightPadding);this.height=w+(this.topPadding+this.bottomPadding);this.ctx.font=s};ha.prototype._getFontString=function(){var h;h=""+(this.fontStyle?this.fontStyle+" ":
"");h+=this.fontWeight?this.fontWeight+" ":"";h+=this.fontSize?this.fontSize+"px ":"";var n=this.fontFamily?this.fontFamily+"":"";!w&&n&&(n=n.split(",")[0],"'"!==n[0]&&'"'!==n[0]&&(n="'"+n+"'"));return h+=n};ma(Ua,V);ma(xa,V);xa.prototype.setLayout=function(){if(this.text){var h=this.dockInsidePlotArea?this.chart.plotArea:this.chart,n=h.layoutManager.getFreeSpace(),w=n.x1,x=n.y1,E=0,I=0,F=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,N,J;"top"===this.verticalAlign||
"bottom"===this.verticalAlign?(null===this.maxWidth&&(this.maxWidth=n.width-4-F*("center"===this.horizontalAlign?2:1)),I=0.5*n.height-this.margin-2,E=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||"right"===this.horizontalAlign?(null===this.maxWidth&&(this.maxWidth=n.height-4),I=0.5*n.width-this.margin-2):"center"===this.horizontalAlign&&(null===this.maxWidth&&(this.maxWidth=n.width-4),I=0.5*n.height-4));var P;s(this.padding)||"number"!==typeof this.padding?s(this.padding)||"object"!==
...
this.ctx=this.chart.ctx;this.ghostCtx=this.chart._eventManager.ghostCtx;this.items=[];this.optionsName="legend";this.height=this.width=0;this.orientation=null;this.dataSeries=[];this.bounds={x1:null,y1:null,x2:null,y2:null};"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.lineHeight=Ya(this.fontFamily,this.fontSize,this.fontWeight);this.horizontalSpacing=this.fontSize}function K(a,d,c,b){K.base.constructor.call(this,"DataSeries","data",d,c,
a);this.chart=a;this.canvas=a.canvas;this._ctx=a.canvas.ctx;this.index=c;this.noDataPointsInPlotArea=0;this.id=b;this.chart._eventManager.objectMap[b]={id:b,objectType:"dataSeries",dataSeriesIndex:c};a=d.dataPoints?d.dataPoints.length:0;this.dataPointEOs=[];for(d=0;d<a;d++)this.dataPointEOs[d]={};this.dataPointIds=[];this.plotUnit=[];this.axisY=this.axisX=null;this.optionsName="data";this.isOptionsInArray=!0;null===this.fillOpacity&&(this.type.match(/area/i)?this.fillOpacity=0.7:this.fillOpacity=
1);this.axisPlacement=this.getDefaultAxisPlacement();"undefined"===typeof this.options.indexLabelFontSize&&(this.indexLabelFontSize=this.chart.getAutoFontSize(this.indexLabelFontSize))}function F(a,d,c,b,e,f){F.base.constructor.call(this,"Axis",d,c,b,a);this.chart=a;this.canvas=a.canvas;this.ctx=a.ctx;this.intervalStartPosition=this.maxHeight=this.maxWidth=0;this.labels=[];this.dataSeries=[];this._stripLineLabels=this._ticks=this._labels=null;this.dataInfo={min:Infinity,max:-Infinity,viewPortMin:Infinity,
...
(this.labelFontSize=this.chart.getAutoFontSize(this.labelFontSize));this.type=e;"axisX"!==e||c&&"undefined"!==typeof c.gridThickness||(this.gridThickness=0);this._position=f;this.lineCoordinates={x1:null,y1:null,x2:null,y2:null,width:null};this.labelAngle=(this.labelAngle%360+360)%360;90<this.labelAngle&&270>this.labelAngle?this.labelAngle-=180:270<=this.labelAngle&&360>=this.labelAngle&&(this.labelAngle-=360);this.options.scaleBreaks&&(this.scaleBreaks=new W(this.chart,this.options.scaleBreaks,++this.chart._eventManager.lastObjectId,
this));this.stripLines=[];if(this.options.stripLines&&0<this.options.stripLines.length)for(a=0;a<this.options.stripLines.length;a++)this.stripLines.push(new P(this.chart,this.options.stripLines[a],a,++this.chart._eventManager.lastObjectId,this));this.options.crosshair&&(this.crosshair=new U(this.chart,this.options.crosshair,this));this._titleTextBlock=null;this.hasOptionChanged("viewportMinimum")&&null===this.viewportMinimum&&(this.options.viewportMinimum=void 0,this.sessionVariables.viewportMinimum=
...
this.startValue)+(this.endValue.getTime?this.endValue.getTime():this.endValue))/2,this._thicknessType=null)}function U(a,d,c){U.base.constructor.call(this,"Crosshair","crosshair",d,null,c);this.chart=a;this.ctx=this.chart.ctx;this.axis=c;this.optionsName="crosshair";this._thicknessType="pixel"}function X(a,d){X.base.constructor.call(this,"ToolTip","toolTip",d,null,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.currentDataPointIndex=this.currentSeriesIndex=-1;this._prevY=this._prevX=
NaN;this.containerTransitionDuration=0.1;this.mozContainerTransition=this.getContainerTransition(this.containerTransitionDuration);this.optionsName="toolTip";this._initialize()}function ca(a){this.chart=a;this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=[];this.previousDataPointEventObject=null;this.ghostCanvas=qa(this.chart.width,this.chart.height);this.ghostCtx=this.ghostCanvas.getContext("2d");this.mouseoveredObjectMaps=[]}function ga(a){this.chart=a;this.ctx=this.chart.plotArea.ctx;
this.animations=[];this.animationRequestId=null}ma(n,V);n.prototype.destroy=function(){var a=this.allDOMEventHandlers;this._animator&&this._animator.cancelAllAnimations();this._panTimerId&&clearTimeout(this._panTimerId);for(var d=0;d<a.length;d++){var c=a[d][0],b=a[d][1],e=a[d][2],f=a[d][3],f=f||!1;c.removeEventListener?c.removeEventListener(b,e,f):c.detachEvent&&c.detachEvent("on"+b,e)}this.allDOMEventHandlers=[];for(this.removeAllEventListeners();this._canvasJSContainer&&this._canvasJSContainer.hasChildNodes();)this._canvasJSContainer.removeChild(this._canvasJSContainer.lastChild);
...
!1;hb(this);"none"!==this._toolBar.style.display&&this._zoomButton&&(this.panEnabled?ta(a,a._zoomButton,"zoom"):ta(a,a._zoomButton,"pan"),a._resetButton.getAttribute("state")!==a._cultureInfo.resetText&&ta(a,a._resetButton,"reset"));this.options.toolTip&&this.toolTip.options!==this.options.toolTip&&(this.toolTip.options=this.options.toolTip);for(var c in this.toolTip.options)this.toolTip.options.hasOwnProperty(c)&&this.toolTip.updateOption(c)};n.prototype._updateSize=function(){var a;a=[this.canvas,
this.overlaidCanvas,this._eventManager.ghostCanvas];var d=0,c=0;this.options.width?d=this.width:this.width=d=0<this.container.clientWidth?this.container.clientWidth:this.width;this.options.height?c=this.height:this.height=c=0<this.container.clientHeight?this.container.clientHeight:this.height;if(this.canvas.width!==d*fa||this.canvas.height!==c*fa){for(var b=0;b<a.length;b++)Ma(a[b],d,c);this.bounds={x1:0,y1:0,x2:this.width,y2:this.height,width:this.width,height:this.height};a=!0}else a=!1;return a};
n.prototype._initialize=function(){this.isNavigator=s(this.parent)||s(this.parent._defaultsKey)||"Navigator"!==this.parent._defaultsKey?!1:!0;this._animator?this._animator.cancelAllAnimations():this._animator=new ga(this);this.removeAllEventListeners();this.disableToolTip=!1;this._axes=[];this.funnelPyramidClickHandler=this.pieDoughnutClickHandler=null;this._updateOptions();this.animatedRender=w&&this.animationEnabled&&0===this.renderCount;this._updateSize();this.clearCanvas();this.ctx.beginPath();
...
"px solid "+this.toolbar.buttonBorderColor,this._zoomButton.style.borderRight=this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.buttonBorderThickness:0)+"px solid "+this.toolbar.buttonBorderColor):(sa(this._zoomButton,this._resetButton),this._toolBar.style.border=this.toolbar.buttonBorderThickness+"px solid transparent",this.options.zoomEnabled&&(this.zoomEnabled=!0,this.panEnabled=!1));fb(this);this._processData();
...
0<m._indexLabels.length&&m.renderIndexLabels();m.dispatchEvent("dataAnimationIterationEnd",{chart:m});m.dispatchEvent("dataAnimationEnd",{chart:m})}this.attachPlotAreaEventHandlers();this.zoomEnabled||(this.panEnabled||!this._zoomButton||"none"===this._zoomButton.style.display)||sa(this._zoomButton,this._resetButton);this.toolTip._updateToolTip();this.renderCount++;Ha&&(m=this,setTimeout(function(){var a=document.getElementById("ghostCanvasCopy");a&&(Ma(a,m.width,m.height),a.getContext("2d").drawImage(m._eventManager.ghostCanvas,
...
a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=[],t=[],B=Infinity,k=-Infinity,m=0;m<a.dataSeriesIndexes.length;m++){var p=this.data[a.dataSeriesIndexes[m]],q=0,g=!1,r=!1,h;if("normal"===p.axisPlacement||"xySwapped"===p.axisPlacement)var Qa=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,
...
b=p.dataPoints[q].x;e=s(p.dataPoints[q].y)?0:p.dataPoints[q].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<q){if(a.axisX.logarithmic){var n=b/p.dataPoints[q-1].x;1>n&&(n=1/n);c.minDiff>n&&1!==n&&(c.minDiff=n)}else n=b-p.dataPoints[q-1].x,0>n&&(n*=-1),c.minDiff>n&&0!==n&&(c.minDiff=n);null!==e&&null!==p.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(n=e/p.dataPoints[q-1].y,1>n&&(n=1/n),d.minDiff>n&&1!==n&&(d.minDiff=n)):(n=e-p.dataPoints[q-1].y,0>n&&(n*=-1),d.minDiff>n&&0!==n&&(d.minDiff=n)))}if(b<Qa&&
...
function(a,d,c){c=c||!1;for(var b=[],e=this._dataInRenderedOrder.length-1;0<=e;e--){var f=null;(f=this._dataInRenderedOrder[e].getDataPointAtXY(a,d,c))&&b.push(f)}a=null;d=!1;for(c=0;c<b.length;c++)if("line"===b[c].dataSeries.type||"stepLine"===b[c].dataSeries.type||"area"===b[c].dataSeries.type||"stepArea"===b[c].dataSeries.type)if(e=ja("markerSize",b[c].dataPoint,b[c].dataSeries)||8,b[c].distance<=e/2){d=!0;break}for(c=0;c<b.length;c++)d&&"line"!==b[c].dataSeries.type&&"stepLine"!==b[c].dataSeries.type&&
...
this.stockChart._rangeEventParameter,this.stockChart)),this.render(),this._dispatchRangeEvent("rangeChanged","zoom"),this.stockChart&&(this.stockChart.navigator&&this.stockChart.navigator.enabled)&&(this.stockChart._rangeEventParameter.type="rangeChanged",this.stockChart.dispatchEvent("rangeChanged",this.stockChart._rangeEventParameter,this.stockChart)),l&&(this.zoomEnabled&&"none"===this._zoomButton.style.display)&&(La(this._zoomButton,this._resetButton),ta(this,this._zoomButton,"pan"),ta(this,this._resetButton,
...
b=0,e=0,f=0,l=f=e=0,t=0,B=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var m=this._indexLabels[a],p=m.chartType.toLowerCase(),q,g,l=ja("indexLabelFontColor",m.dataPoint,m.dataSeries),r=ja("indexLabelFontSize",m.dataPoint,m.dataSeries),t=ja("indexLabelFontFamily",m.dataPoint,m.dataSeries),B=ja("indexLabelFontStyle",m.dataPoint,m.dataSeries),k=ja("indexLabelFontWeight",m.dataPoint,m.dataSeries),h=ja("indexLabelBackgroundColor",m.dataPoint,m.dataSeries);q=ja("indexLabelMaxWidth",m.dataPoint,m.dataSeries);
g=ja("indexLabelWrap",m.dataPoint,m.dataSeries);var n=ja("indexLabelLineDashType",m.dataPoint,m.dataSeries),u=ja("indexLabelLineColor",m.dataPoint,m.dataSeries),y=s(m.dataPoint.indexLabelLineThickness)?s(m.dataSeries.options.indexLabelLineThickness)?0:m.dataSeries.options.indexLabelLineThickness:m.dataPoint.indexLabelLineThickness,b=0<y?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,z={percent:null,total:null},C=null;if(0<=m.dataSeries.type.indexOf("stacked")||
...
m.dataSeries.indexLabelFormatter(C):m.dataSeries.indexLabel?this.replaceKeywordsWithValue(m.dataSeries.indexLabel,m.dataPoint,m.dataSeries,null,m.indexKeyword):null;if(null!==D&&""!==D){var z=ja("indexLabelPlacement",m.dataPoint,m.dataSeries),C=ja("indexLabelOrientation",m.dataPoint,m.dataSeries),A=ja("indexLabelTextAlign",m.dataPoint,m.dataSeries),v=m.direction,e=m.dataSeries.axisX,f=m.dataSeries.axisY,x=!1,h=new ha(d,{x:0,y:0,maxWidth:q?q:0.5*this.width,maxHeight:g?5*r:1.5*r,angle:"horizontal"===
...
y,s,c);f.push(A);D=Q(D);w&&f.push({x:y,y:s,ctx:b,type:A.type,size:A.size,color:D,borderColor:D,borderThickness:A.borderThickness})}(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:m[u],dataSeries:k,point:{x:y,y:s},direction:0>m[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();w&&b.stroke()}}Z.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
...
c.setLineDash(N(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<m[u].markerSize||0<k.markerSize)D=k.getMarkerProperties(u,y,s,c),f.push(D),A=Q(A),w&&f.push({x:y,y:s,ctx:b,type:D.type,size:D.size,color:A,borderColor:A,borderThickness:D.borderThickness});(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:m[u],dataSeries:k,point:{x:y,y:s},direction:0>m[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();
...
var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],t=0;t<a.dataSeriesIndexes.length;t++){var B=a.dataSeriesIndexes[t],k=this.data[B];b.lineWidth=k.lineThickness;var m=k.dataPoints,p="solid";if(b.setLineDash){var q=N(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=N(p,k.lineThickness);b.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=Q(r);e.strokeStyle=r;e.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,
...
B=r[f].x,!(B<a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){l=a.axisX.convertValueToPixel(B);t=a.axisY.convertValueToPixel(r[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+m)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+m)*p<<0;var n=a.axisX.reversed?l-p<<0:l+p<<0,u;0<=r[f].y?u=k:(u=t,t=k);t>u&&(b=t,t=u,u=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];aa(c,a.axisX.reversed?n:l,t,a.axisX.reversed?
l:n,u,b,0,null,h&&(a.axisY.reversed?0>r[f].y:0<=r[f].y),(a.axisY.reversed?0<=r[f].y:0>r[f].y)&&h,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:t,x2:n,y2:u};b=Q(b);w&&aa(this._eventManager.ghostCtx,a.axisX.reversed?n:l,t,a.axisX.reversed?l:n,u,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:r[f],
dataSeries:g,point:{x:l+(n-l)/2,y:0>r[f].y===a.axisY.reversed?t:u},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:l,y1:Math.min(t,u),x2:n,y2:Math.max(t,u)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:k<a.axisY.bounds.y1?a.axisY.bounds.y1:k>a.axisY.bounds.y2?a.axisY.bounds.y2:k}}};n.prototype.renderStackedColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,
f=[],l=[],t=[],B=[],k=0,m,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;m=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(g)/
...
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],n=this.data[h],u=n.dataPoints;if(0<u.length){var s=5<g&&n.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){m=a.axisX.convertValueToPixel(b);var z=m-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=z+g<<0,D;if(a.axisY.logarithmic||
...
l[b]?l[b]:0,D=p+A,p=q+A,l[b]=A+(D-p);b=u[k].color?u[k].color:n._colorSet[k%n._colorSet.length];aa(c,z,a.axisY.reversed?D:p,C,a.axisY.reversed?p:D,b,0,null,s&&(a.axisY.reversed?0>u[k].y:0<=u[k].y),(a.axisY.reversed?0<=u[k].y:0>u[k].y)&&s,!1,!1,n.fillOpacity);b=n.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:z,y1:p,x2:C,y2:D};b=Q(b);w&&aa(this._eventManager.ghostCtx,z,p,C,D,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||n.indexLabel||u[k].indexLabelFormatter||
n.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:u[k],dataSeries:n,point:{x:m,y:0<=u[k].y?p:D},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:z,y1:Math.min(p,D),x2:C,y2:Math.max(p,D)},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};n.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:
...
c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],n=this.data[h],u=n.dataPoints;if(0<u.length)for(var s=5<g&&n.bevelEnabled?!0:!1,k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){m=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?
100*(u[k].y/a.dataPointYSums[b]):0;var z=m-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=z+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y){t[b]=p+("undefined"!==typeof t[b]?t[b]:0);if(0>=t[b])continue;p=a.axisY.convertValueToPixel(t[b]);D=f[b]?f[b]:q;f[b]=p}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)B[b]=p+("undefined"!==typeof B[b]?B[b]:0),D=a.axisY.convertValueToPixel(B[b]),p=l[b]?l[b]:q,l[b]=D;
else if(p=a.axisY.convertValueToPixel(p),0<=u[k].y){var A="undefined"!==typeof f[b]?f[b]:0;p-=A;D=q-A;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y1-p)&&(p=e.y1);f[b]=A+(D-p)}else A="undefined"!==typeof l[b]?l[b]:0,D=p+A,p=q+A,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y2-D)&&(D=e.y2),l[b]=A+(D-p);b=u[k].color?u[k].color:n._colorSet[k%n._colorSet.length];aa(c,z,a.axisY.reversed?D:p,C,a.axisY.reversed?p:D,b,0,null,s&&(a.axisY.reversed?0>u[k].y:0<=u[k].y),(a.axisY.reversed?0<=u[k].y:0>u[k].y)&&
s,!1,!1,n.fillOpacity);b=n.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:z,y1:p,x2:C,y2:D};b=Q(b);w&&aa(this._eventManager.ghostCtx,z,p,C,D,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||n.indexLabel||u[k].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn100",dataPoint:u[k],dataSeries:n,point:{x:m,y:0<=u[k].y?p:D},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:z,y1:Math.min(p,D),x2:C,y2:Math.max(p,
...
animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};n.prototype.renderBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,t,B,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?
...
a.dataSeriesIndexes[m],g=this.data[q],r=g.dataPoints;if(0<r.length){var h=5<p&&g.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<r.length;f++)if(r[f].getTime?B=r[f].x.getTime():B=r[f].x,!(B<a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){t=a.axisX.convertValueToPixel(B);l=a.axisY.convertValueToPixel(r[f].y);t=a.axisX.reversed?t+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+m)*p<<0:t-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+
m)*p<<0;var n=a.axisX.reversed?t-p<<0:t+p<<0,u;0<=r[f].y?u=k:(u=l,l=k);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];aa(c,a.axisY.reversed?l:u,a.axisX.reversed?n:t,a.axisY.reversed?u:l,a.axisX.reversed?t:n,b,0,null,h,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:u,y1:t,x2:l,y2:n};b=Q(b);w&&aa(this._eventManager.ghostCtx,u,a.axisX.reversed?n:t,l,a.axisX.reversed?t:n,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||
...
0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:k<a.axisY.bounds.x1?a.axisY.bounds.x1:k>a.axisY.bounds.x2?a.axisY.bounds.x2:k}}};n.prototype.renderStackedBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,
...
typeof u[k].y){p=a.axisX.convertValueToPixel(b);var z=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=z+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(D=f[b]?f[b]:q,f[b]=m=a.axisY.convertValueToPixel(t[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)B[b]=u[k].y+(B[b]?B[b]:0),m=l[b]?l[b]:q,l[b]=D=a.axisY.convertValueToPixel(B[b]);else if(m=a.axisY.convertValueToPixel(u[k].y),
0<=u[k].y){var A=f[b]?f[b]:0;D=q+A;m+=A;f[b]=A+(m-D)}else A=l[b]?l[b]:0,D=m-A,m=q-A,l[b]=A+(m-D);b=u[k].color?u[k].color:n._colorSet[k%n._colorSet.length];aa(c,a.axisY.reversed?m:D,z,a.axisY.reversed?D:m,C,b,0,null,s,!1,!1,!1,n.fillOpacity);b=n.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:D,y1:z,x2:m,y2:C};b=Q(b);w&&aa(this._eventManager.ghostCtx,D,z,m,C,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||n.indexLabel||u[k].indexLabelFormatter||
n.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:u[k],dataSeries:n,point:{x:0<=u[k].y?m:D,y:p},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(D,m),y1:z,x2:Math.max(D,m),y2:C},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&
this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};n.prototype.renderStackedBar100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
null,e=this.plotArea,f=[],l=[],t=[],B=[],k=0,m,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;p=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.height<<0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?
...
this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],n=this.data[h],u=n.dataPoints;if(0<u.length){var s=5<g&&n.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){p=a.axisX.convertValueToPixel(b);var z;z=0!==a.dataPointYSums[b]?100*
(u[k].y/a.dataPointYSums[b]):0;var C=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,D=C+g<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y){t[b]=z+(t[b]?t[b]:0);if(0>=t[b])continue;z=f[b]?f[b]:q;f[b]=m=a.axisY.convertValueToPixel(t[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)B[b]=z+(B[b]?B[b]:0),m=l[b]?l[b]:q,l[b]=z=a.axisY.convertValueToPixel(B[b]);else if(m=a.axisY.convertValueToPixel(z),0<=u[k].y){var A=
f[b]?f[b]:0;z=q+A;m+=A;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x2-m)&&(m=e.x2);f[b]=A+(m-z)}else A=l[b]?l[b]:0,z=m-A,m=q-A,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x1-z)&&(z=e.x1),l[b]=A+(m-z);b=u[k].color?u[k].color:n._colorSet[k%n._colorSet.length];aa(c,a.axisY.reversed?m:z,C,a.axisY.reversed?z:m,D,b,0,null,s,!1,!1,!1,n.fillOpacity);b=n.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:z,y1:C,x2:m,y2:D};b=Q(b);w&&aa(this._eventManager.ghostCtx,
z,C,m,D,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||n.indexLabel||u[k].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:u[k],dataSeries:n,point:{x:0<=u[k].y?m:z,y:p},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(z,m),y1:C,x2:Math.max(z,m),y2:D},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};n.prototype.renderArea=
function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=z:0>a.axisY.viewportMaximum?C=t.y1:0<a.axisY.viewportMinimum&&(C=z),f.lineTo(n,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(n,C),l.lineTo(D.x,C),l.closePath(),l.fill()),f.beginPath(),f.moveTo(n,u),l.beginPath(),l.moveTo(n,u),D={x:n,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:
e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,B=[],k=this.plotArea,m;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,B=g.id;this._eventManager.objectMap[B]={objectType:"dataSeries",dataSeriesIndex:q};B=Q(B);l.fillStyle=B;B=[];d=!0;var h=0,n,u,s,z=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),C,D=null;if(0<r.length){var A=g._colorSet[h%g._colorSet.length],v=g.lineColor=g.options.lineColor||A,x=v;f.fillStyle=A;f.strokeStyle=v;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var T=N(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var O=N(c,g.lineThickness);f.setLineDash(O)}for(var ia=!0;h<r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ia)))if("number"!==
typeof r[h].y)g.connectNullData||(ia||d)||b(),ia=!0;else{n=a.axisX.convertValueToPixel(s);u=a.axisY.convertValueToPixel(r[h].y);d||ia?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=n,c=u,n=m.x,u=m.y,b(),f.moveTo(m.x,m.y),n=d,u=c,D=m,c=g.nullDataLineDashType,f.setLineDash(T)),f.lineTo(n,u),w&&l.lineTo(n,u)):(f.beginPath(),f.moveTo(n,u),w&&(l.beginPath(),l.moveTo(n,u)),D={x:n,y:u}),ia=d=!1):(f.lineTo(n,u),w&&l.lineTo(n,
u),0==h%250&&b());m={x:n,y:u};h<r.length-1&&(x!==(r[h].lineColor||v)||c!==(r[h].lineDashType||g.lineDashType))&&(b(),x=r[h].lineColor||v,f.strokeStyle=x,f.setLineDash&&(r[h].lineDashType?(c=r[h].lineDashType,f.setLineDash(N(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(O))));var $=g.dataPointIds[h];this._eventManager.objectMap[$]={id:$,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:n,y1:u};0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(h,n,
u,f),B.push(s),$=Q($),w&&B.push({x:n,y:u,ctx:l,type:s.type,size:s.size,color:$,borderColor:$,borderThickness:s.borderThickness}));(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[h],dataSeries:g,point:{x:n,y:u},direction:0>r[h].y===a.axisY.reversed?1:-1,color:A})}b();Z.drawMarkers(B)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,
0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(k.x1,k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderSplineArea=function(a){function d(){var c=v(s,2);if(0<c.length){if(0<
m.lineThickness){b.beginPath();b.moveTo(c[0].x,c[0].y);c[0].newStrokeStyle&&(b.strokeStyle=c[0].newStrokeStyle);c[0].newLineDashArray&&b.setLineDash(c[0].newLineDashArray);for(var d=0;d<c.length-3;d+=3)if(b.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y),w&&e.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y),c[d+3].newStrokeStyle||c[d+3].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(c[d+3].x,c[d+3].y),c[d+3].newStrokeStyle&&(b.strokeStyle=c[d+3].newStrokeStyle),
c[d+3].newLineDashArray&&b.setLineDash(c[d+3].newLineDashArray);b.stroke()}b.beginPath();b.moveTo(c[0].x,c[0].y);w&&(e.beginPath(),e.moveTo(c[0].x,c[0].y));for(d=0;d<c.length-3;d+=3)b.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y),w&&e.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y);a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?n=h:0>a.axisY.viewportMaximum?n=f.y1:0<a.axisY.viewportMinimum&&(n=h);u={x:c[0].x,y:c[0].y};b.lineTo(c[c.length-
1].x,n);b.lineTo(u.x,n);b.closePath();b.globalAlpha=m.fillOpacity;b.fill();b.globalAlpha=1;w&&(e.lineTo(c[c.length-1].x,n),e.lineTo(u.x,n),e.closePath(),e.fill())}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=a.axisY.lineCoordinates,l=[],t=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(t.x1,t.y1,t.width,t.height);b.clip();w&&(e.beginPath(),e.rect(t.x1,t.y1,t.width,t.height),e.clip());for(var B=
0;B<a.dataSeriesIndexes.length;B++){var k=a.dataSeriesIndexes[B],m=this.data[k],p=m.dataPoints,l=m.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=Q(l);e.fillStyle=l;var l=[],q=0,g,r,h=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),n,u=null,s=[];if(0<p.length){var z=m._colorSet[q%m._colorSet.length],C=m.lineColor=m.options.lineColor||z,D=C;b.fillStyle=z;b.strokeStyle=C;b.lineWidth=m.lineThickness;var A="solid";if(b.setLineDash){var x=N(m.nullDataLineDashType,
m.lineThickness),A=m.lineDashType,F=N(A,m.lineThickness);b.setLineDash(F)}for(r=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!r)))if("number"!==typeof p[q].y)0<q&&!r&&(m.connectNullData?b.setLineDash&&(0<s.length&&(m.options.nullDataLineDashType||!p[q-1].lineDashType))&&(s[s.length-1].newLineDashArray=x,A=m.nullDataLineDashType):(d(),s=[])),r=!0;else{g=a.axisX.convertValueToPixel(g);r=a.axisY.convertValueToPixel(p[q].y);
var T=m.dataPointIds[q];this._eventManager.objectMap[T]={id:T,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:r};s[s.length]={x:g,y:r};q<p.length-1&&(D!==(p[q].lineColor||C)||A!==(p[q].lineDashType||m.lineDashType))&&(D=p[q].lineColor||C,s[s.length-1].newStrokeStyle=D,b.setLineDash&&(p[q].lineDashType?(A=p[q].lineDashType,s[s.length-1].newLineDashArray=N(A,m.lineThickness)):(A=m.lineDashType,s[s.length-1].newLineDashArray=F)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<m.markerSize)){var O=
m.getMarkerProperties(q,g,r,b);l.push(O);T=Q(T);w&&l.push({x:g,y:r,ctx:e,type:O.type,size:O.size,color:T,borderColor:T,borderThickness:O.borderThickness})}(p[q].indexLabel||m.indexLabel||p[q].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:m,point:{x:g,y:r},direction:0>p[q].y===a.axisY.reversed?1:-1,color:z});r=!1}d();Z.drawMarkers(l)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation=
"source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderStepArea=
function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=z:0>a.axisY.viewportMaximum?C=t.y1:0<a.axisY.viewportMinimum&&(C=z),f.lineTo(n,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(n,C),l.lineTo(D.x,C),l.closePath(),l.fill()),f.beginPath(),f.moveTo(n,u),l.beginPath(),l.moveTo(n,u),D={x:n,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:
e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,B=[],k=this.plotArea,m;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,B=g.id;this._eventManager.objectMap[B]={objectType:"dataSeries",dataSeriesIndex:q};B=Q(B);l.fillStyle=B;B=[];d=!0;var h=0,n,u,s,z=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),C,D=null;c=!1;if(0<r.length){var A=g._colorSet[h%g._colorSet.length],v=g.lineColor=g.options.lineColor||A,x=v;f.fillStyle=A;f.strokeStyle=v;f.lineWidth=g.lineThickness;var T="solid";if(f.setLineDash){var O=N(g.nullDataLineDashType,g.lineThickness),T=g.lineDashType,F=N(T,g.lineThickness);f.setLineDash(F)}for(;h<r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var $=u;"number"!==
typeof r[h].y?(g.connectNullData||(c||d)||b(),c=!0):(n=a.axisX.convertValueToPixel(s),u=a.axisY.convertValueToPixel(r[h].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||T===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=n,c=u,n=m.x,u=m.y,b(),f.moveTo(m.x,m.y),n=d,u=c,D=m,T=g.nullDataLineDashType,f.setLineDash(O)),f.lineTo(n,$),f.lineTo(n,u),w&&(l.lineTo(n,$),l.lineTo(n,u))):(f.beginPath(),f.moveTo(n,u),w&&(l.beginPath(),l.moveTo(n,u)),D={x:n,y:u}),c=d=
!1):(f.lineTo(n,$),w&&l.lineTo(n,$),f.lineTo(n,u),w&&l.lineTo(n,u),0==h%250&&b()),m={x:n,y:u},h<r.length-1&&(x!==(r[h].lineColor||v)||T!==(r[h].lineDashType||g.lineDashType))&&(b(),x=r[h].lineColor||v,f.strokeStyle=x,f.setLineDash&&(r[h].lineDashType?(T=r[h].lineDashType,f.setLineDash(N(T,g.lineThickness))):(T=g.lineDashType,f.setLineDash(F)))),s=g.dataPointIds[h],this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:n,y1:u},0!==r[h].markerSize&&(0<r[h].markerSize||
0<g.markerSize)&&($=g.getMarkerProperties(h,n,u,f),B.push($),s=Q(s),w&&B.push({x:n,y:u,ctx:l,type:$.type,size:$.size,color:s,borderColor:s,borderThickness:$.borderThickness})),(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:r[h],dataSeries:g,point:{x:n,y:u},direction:0>r[h].y===a.axisY.reversed?1:-1,color:A}))}b();Z.drawMarkers(B)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation=
"source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(k.x1,k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderStackedArea=
function(a){function d(){if(!(1>k.length)){for(0<A.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=A.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(s.closePath(),s.fill(),s.beginPath());k=[]}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],t=this.plotArea,h=[],k=[],m=[],p=[],q=0,g,r,n=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:
0),s=this._eventManager.ghostCtx,u,y,z;w&&s.beginPath();b.save();w&&s.save();b.beginPath();b.rect(t.x1,t.y1,t.width,t.height);b.clip();w&&(s.beginPath(),s.rect(t.x1,t.y1,t.width,t.height),s.clip());for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var D=a.dataSeriesIndexes[C],A=this.data[D],v=A.dataPoints;A.dataPointIndexes=[];for(q=0;q<v.length;q++)D=v[q].x.getTime?v[q].x.getTime():v[q].x,A.dataPointIndexes[D]=q,e[D]||(m.push(D),e[D]=!0);m.sort(Ra)}for(C=0;C<a.dataSeriesIndexes.length;C++){D=a.dataSeriesIndexes[C];
A=this.data[D];v=A.dataPoints;y=!0;k=[];q=A.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:D};q=Q(q);s.fillStyle=q;if(0<m.length){var e=A._colorSet[0],x=A.lineColor=A.options.lineColor||e,T=x;b.fillStyle=e;b.strokeStyle=x;b.lineWidth=A.lineThickness;z="solid";if(b.setLineDash){var O=N(A.nullDataLineDashType,A.lineThickness);z=A.lineDashType;var F=N(z,A.lineThickness);b.setLineDash(F)}for(var $=!0,q=0;q<m.length;q++){var f=m[q],ea=null,ea=0<=A.dataPointIndexes[f]?v[A.dataPointIndexes[f]]:
{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!A.connectNullData||!$)))if("number"!==typeof ea.y)A.connectNullData||($||y)||d(),$=!0;else{g=a.axisX.convertValueToPixel(f);var ka=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=ea.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(ea.y),r-=ka;k.push({x:g,y:n-ka});h[f]=n-r;y||$?(!y&&
A.connectNullData?(b.setLineDash&&(A.options.nullDataLineDashType||z===A.lineDashType&&A.lineDashType!==A.nullDataLineDashType)&&(y=k.pop(),z=k[k.length-1],d(),b.moveTo(u.x,u.y),k.push(z),k.push(y),z=A.nullDataLineDashType,b.setLineDash(O)),b.lineTo(g,r),w&&s.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(s.beginPath(),s.moveTo(g,r))),$=y=!1):(b.lineTo(g,r),w&&s.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&s.moveTo(g,r),k.push({x:g,y:n-ka})));u={x:g,y:r};q<v.length-1&&(T!==(v[q].lineColor||x)||z!==
(v[q].lineDashType||A.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:n-ka}),T=v[q].lineColor||x,b.strokeStyle=T,b.setLineDash&&(v[q].lineDashType?(z=v[q].lineDashType,b.setLineDash(N(z,A.lineThickness))):(z=A.lineDashType,b.setLineDash(F))));if(0<=A.dataPointIndexes[f]){var E=A.dataPointIds[A.dataPointIndexes[f]];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:A.dataPointIndexes[f],x1:g,y1:r}}0<=A.dataPointIndexes[f]&&0!==ea.markerSize&&
(0<ea.markerSize||0<A.markerSize)&&(ka=A.getMarkerProperties(A.dataPointIndexes[f],g,r,b),l.push(ka),f=Q(E),w&&l.push({x:g,y:r,ctx:s,type:ka.type,size:ka.size,color:f,borderColor:f,borderThickness:ka.borderThickness}));(ea.indexLabel||A.indexLabel||ea.indexLabelFormatter||A.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:ea,dataSeries:A,point:{x:g,y:r},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&s.moveTo(g,r)}delete A.dataPointIndexes}Z.drawMarkers(l);
w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,
easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderStackedArea100=function(a){function d(){for(0<A.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&z.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=A.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(z.closePath(),z.fill(),z.beginPath());k=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,t=[],h=[],k=[],m=[],p=[],q=
0,g,r,n,s,u,y=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),z=this._eventManager.ghostCtx;b.save();w&&z.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(z.beginPath(),z.rect(l.x1,l.y1,l.width,l.height),z.clip());for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var D=a.dataSeriesIndexes[C],A=this.data[D],v=A.dataPoints;A.dataPointIndexes=[];for(q=0;q<v.length;q++)D=v[q].x.getTime?v[q].x.getTime():v[q].x,A.dataPointIndexes[D]=q,e[D]||(m.push(D),e[D]=
!0);m.sort(Ra)}for(C=0;C<a.dataSeriesIndexes.length;C++){D=a.dataSeriesIndexes[C];A=this.data[D];v=A.dataPoints;s=!0;e=A.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:D};e=Q(e);z.fillStyle=e;k=[];if(0<m.length){var e=A._colorSet[q%A._colorSet.length],x=A.lineColor=A.options.lineColor||e,T=x;b.fillStyle=e;b.strokeStyle=x;b.lineWidth=A.lineThickness;u="solid";if(b.setLineDash){var O=N(A.nullDataLineDashType,A.lineThickness);u=A.lineDashType;var F=N(u,A.lineThickness);b.setLineDash(F)}for(var $=
!0,q=0;q<m.length;q++){var f=m[q],ea=null,ea=0<=A.dataPointIndexes[f]?v[A.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!A.connectNullData||!$)))if("number"!==typeof ea.y)A.connectNullData||($||s)||d(),$=!0;else{var ka;ka=0!==a.dataPointYSums[f]?100*(ea.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);var E=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=ka+(p[f]?p[f]:0);if(0>=
p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(ka),r-=E;k.push({x:g,y:y-E});h[f]=y-r;s||$?(!s&&A.connectNullData?(b.setLineDash&&(A.options.nullDataLineDashType||u===A.lineDashType&&A.lineDashType!==A.nullDataLineDashType)&&(s=k.pop(),u=k[k.length-1],d(),b.moveTo(n.x,n.y),k.push(u),k.push(s),u=A.nullDataLineDashType,b.setLineDash(O)),b.lineTo(g,r),w&&z.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(z.beginPath(),z.moveTo(g,r))),$=s=!1):(b.lineTo(g,
r),w&&z.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&z.moveTo(g,r),k.push({x:g,y:y-E})));n={x:g,y:r};q<v.length-1&&(T!==(v[q].lineColor||x)||u!==(v[q].lineDashType||A.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:y-E}),T=v[q].lineColor||x,b.strokeStyle=T,b.setLineDash&&(v[q].lineDashType?(u=v[q].lineDashType,b.setLineDash(N(u,A.lineThickness))):(u=A.lineDashType,b.setLineDash(F))));if(0<=A.dataPointIndexes[f]){var G=A.dataPointIds[A.dataPointIndexes[f]];this._eventManager.objectMap[G]=
{id:G,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:A.dataPointIndexes[f],x1:g,y1:r}}0<=A.dataPointIndexes[f]&&0!==ea.markerSize&&(0<ea.markerSize||0<A.markerSize)&&(E=A.getMarkerProperties(q,g,r,b),t.push(E),f=Q(G),w&&t.push({x:g,y:r,ctx:z,type:E.type,size:E.size,color:f,borderColor:f,borderThickness:E.borderThickness}));(ea.indexLabel||A.indexLabel||ea.indexLabelFormatter||A.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:ea,dataSeries:A,point:{x:g,y:r},
direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&z.moveTo(g,r)}delete A.dataPointIndexes}Z.drawMarkers(t);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.clip());for(var t=-Infinity,h=Infinity,k=0;k<a.dataSeriesIndexes.length;k++)for(var m=a.dataSeriesIndexes[k],p=this.data[m],q=p.dataPoints,g=0,e=0;e<q.length;e++)f=q[e].getTime?f=q[e].x.getTime():f=q[e].x,f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax||"undefined"===typeof q[e].z||(g=q[e].z,g>t&&(t=g),g<h&&(h=g));for(var r=25*Math.PI,n=Math.max(Math.pow(0.25*Math.min(b.height,b.width)/2,2)*Math.PI,
r),k=0;k<a.dataSeriesIndexes.length;k++)if(m=a.dataSeriesIndexes[k],p=this.data[m],q=p.dataPoints,0<q.length)for(c.strokeStyle="#4572A7 ",e=0;e<q.length;e++)if(f=q[e].getTime?f=q[e].x.getTime():f=q[e].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof q[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(q[e].y);var g=q[e].z,s=2*Math.max(Math.sqrt((t===h?n/2:r+(n-r)/(t-h)*(g-h))/Math.PI)<<0,1),g=p.getMarkerProperties(e,c);g.size=s;c.globalAlpha=
p.fillOpacity;Z.drawMarker(f,l,c,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;var u=p.dataPointIds[e];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:e,x1:f,y1:l,size:s};s=Q(u);w&&Z.drawMarker(f,l,this._eventManager.ghostCtx,g.type,g.size,s,s,g.borderThickness);(q[e].indexLabel||p.indexLabel||q[e].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"bubble",dataPoint:q[e],dataSeries:p,point:{x:f,y:l},
...
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};n.prototype.renderScatter=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(b.x1,b.y1,
b.width,b.height),this._eventManager.ghostCtx.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=a.dataSeriesIndexes[t],k=this.data[h],m=k.dataPoints;if(0<m.length){c.strokeStyle="#4572A7 ";Math.pow(0.3*Math.min(b.height,b.width)/2,2);for(var p=0,q=0,e=0;e<m.length;e++)if(f=m[e].getTime?f=m[e].x.getTime():f=m[e].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof m[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(m[e].y);var g=k.getMarkerProperties(e,
f,l,c);c.globalAlpha=k.fillOpacity;Z.drawMarker(g.x,g.y,g.ctx,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;Math.sqrt((p-f)*(p-f)+(q-l)*(q-l))<Math.min(g.size,5)&&m.length>Math.min(this.plotArea.width,this.plotArea.height)||(p=k.dataPointIds[e],this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:e,x1:f,y1:l},p=Q(p),w&&Z.drawMarker(g.x,g.y,this._eventManager.ghostCtx,g.type,g.size,p,p,g.borderThickness),(m[e].indexLabel||k.indexLabel||
m[e].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"scatter",dataPoint:m[e],dataSeries:k,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null}),p=f,q=l)}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};n.prototype.renderCandlestick=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=
...
this.dataPointMaxWidth&&e>f&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,f));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&f<e)&&(f=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));r<e&&(r=e);r>f&&(r=f);c.save();w&&b.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();w&&(b.beginPath(),b.rect(l.x1,l.y1,l.width,l.height),b.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var Qa=a.dataSeriesIndexes[n],u=this.data[Qa],y=u.dataPoints;
if(0<y.length)for(var z=5<r&&u.bevelEnabled?!0:!1,t=0;t<y.length;t++)if(y[t].getTime?g=y[t].x.getTime():g=y[t].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(y[t].y)&&y[t].y.length&&"number"===typeof y[t].y[0]&&"number"===typeof y[t].y[1]&&"number"===typeof y[t].y[2]&&"number"===typeof y[t].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(y[t].y[0]);m=a.axisY.convertValueToPixel(y[t].y[1]);p=a.axisY.convertValueToPixel(y[t].y[2]);q=a.axisY.convertValueToPixel(y[t].y[3]);
var C=h-r/2<<0,v=C+r<<0,f=u.options.fallingColor?u.fallingColor:u._colorSet[0],e=y[t].color?y[t].color:u._colorSet[0],A=Math.round(Math.max(1,0.15*r)),x=0===A%2?0:0.5,F=u.dataPointIds[t];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:Qa,dataPointIndex:t,x1:C,y1:k,x2:v,y2:m,x3:h,y3:p,x4:h,y4:q,borderThickness:A,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=A;b.lineWidth=Math.max(A,4);"candlestick"===u.type?(c.moveTo(h-x,m),c.lineTo(h-x,Math.min(k,q)),c.stroke(),c.moveTo(h-
x,Math.max(k,q)),c.lineTo(h-x,p),c.stroke(),aa(c,C,Math.min(k,q),v,Math.max(k,q),y[t].y[0]<=y[t].y[3]?u.risingColor:f,A,e,z,z,!1,!1,u.fillOpacity),w&&(e=Q(F),b.strokeStyle=e,b.moveTo(h-x,m),b.lineTo(h-x,Math.min(k,q)),b.stroke(),b.moveTo(h-x,Math.max(k,q)),b.lineTo(h-x,p),b.stroke(),aa(b,C,Math.min(k,q),v,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===u.type&&(c.moveTo(h-x,m),c.lineTo(h-x,p),c.stroke(),c.beginPath(),c.moveTo(h,k),c.lineTo(C,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(v,q),
c.stroke(),w&&(e=Q(F),b.strokeStyle=e,b.moveTo(h-x,m),b.lineTo(h-x,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(C,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(v,q),b.stroke()));(y[t].indexLabel||u.indexLabel||y[t].indexLabelFormatter||u.indexLabelFormatter)&&this._indexLabels.push({chartType:u.type,dataPoint:y[t],dataSeries:u,point:{x:C+(v-C)/2,y:a.axisY.reversed?p:m},direction:1,bounds:{x1:C,y1:Math.min(m,p),x2:v,y2:Math.max(m,p)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,
this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(l.x1,l.y1,l.width,l.height),b.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,
...
(r=0.3*Math.abs(a.axisX.range));r=this.options.dataPointWidth?this.dataPointWidth:0.7*f.width*(a.axisX.logarithmic?Math.log(r)/Math.log(a.axisX.range):Math.abs(r)/Math.abs(a.axisX.range))<<0;this.dataPointMaxWidth&&e>l&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<e)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));r<e&&(r=e);r>l&&(r=l);c.save();w&&b.save();c.beginPath();c.rect(f.x1,f.y1,f.width,
f.height);c.clip();w&&(b.beginPath(),b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var n=!1,n=!!a.axisY.reversed,v=0;v<a.dataSeriesIndexes.length;v++){var u=a.dataSeriesIndexes[v],y=this.data[u],z=y.dataPoints;if(0<z.length)for(var C=5<r&&y.bevelEnabled?!0:!1,l=0;l<z.length;l++)if(z[l].getTime?g=z[l].x.getTime():g=z[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(z[l].y)&&z[l].y.length&&"number"===typeof z[l].y[0]&&"number"===typeof z[l].y[1]&&"number"===typeof z[l].y[2]&&
"number"===typeof z[l].y[3]&&"number"===typeof z[l].y[4]&&5===z[l].y.length){t=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(z[l].y[0]);k=a.axisY.convertValueToPixel(z[l].y[1]);m=a.axisY.convertValueToPixel(z[l].y[2]);p=a.axisY.convertValueToPixel(z[l].y[3]);q=a.axisY.convertValueToPixel(z[l].y[4]);var D=t-r/2<<0,A=t+r/2<<0,e=z[l].color?z[l].color:y._colorSet[0],x=Math.round(Math.max(1,0.15*r)),F=0===x%2?0:0.5,T=z[l].whiskerColor?z[l].whiskerColor:z[l].color?y.whiskerColor?y.whiskerColor:
z[l].color:y.whiskerColor?y.whiskerColor:e,O="number"===typeof z[l].whiskerThickness?z[l].whiskerThickness:"number"===typeof y.options.whiskerThickness?y.whiskerThickness:x,E=z[l].whiskerDashType?z[l].whiskerDashType:y.whiskerDashType,$=s(z[l].whiskerLength)?s(y.options.whiskerLength)?r:y.whiskerLength:z[l].whiskerLength,$="number"===typeof $?0>=$?0:$>=r?r:$:"string"===typeof $?parseInt($)*r/100>r?r:parseInt($)*r/100:r,ea=1===Math.round(O)%2?0.5:0,ka=z[l].stemColor?z[l].stemColor:z[l].color?y.stemColor?
y.stemColor:z[l].color:y.stemColor?y.stemColor:e,Aa="number"===typeof z[l].stemThickness?z[l].stemThickness:"number"===typeof y.options.stemThickness?y.stemThickness:x,G=1===Math.round(Aa)%2?0.5:0,I=z[l].stemDashType?z[l].stemDashType:y.stemDashType,J=z[l].lineColor?z[l].lineColor:z[l].color?y.lineColor?y.lineColor:z[l].color:y.lineColor?y.lineColor:e,K="number"===typeof z[l].lineThickness?z[l].lineThickness:"number"===typeof y.options.lineThickness?y.lineThickness:x,P=z[l].lineDashType?z[l].lineDashType:
y.lineDashType,L=1===Math.round(K)%2?0.5:0,S=y.upperBoxColor,ua=y.lowerBoxColor,pa=s(y.options.fillOpacity)?1:y.fillOpacity,R=y.dataPointIds[l];this._eventManager.objectMap[R]={id:R,objectType:"dataPoint",dataSeriesIndex:u,dataPointIndex:l,x1:D,y1:h,x2:A,y2:k,x3:t,y3:m,x4:t,y4:p,y5:q,borderThickness:x,color:e,stemThickness:Aa,stemColor:ka,whiskerThickness:O,whiskerLength:$,whiskerColor:T,lineThickness:K,lineColor:J};c.save();0<Aa&&(c.beginPath(),c.strokeStyle=ka,c.lineWidth=Aa,c.setLineDash&&c.setLineDash(N(I,
Aa)),c.moveTo(t-G,k),c.lineTo(t-G,h),c.stroke(),c.moveTo(t-G,p),c.lineTo(t-G,m),c.stroke());c.restore();b.lineWidth=Math.max(x,4);c.beginPath();aa(c,D,Math.min(q,k),A,Math.max(k,q),ua,0,e,n?C:!1,n?!1:C,!1,!1,pa);c.beginPath();aa(c,D,Math.min(m,q),A,Math.max(q,m),S,0,e,n?!1:C,n?C:!1,!1,!1,pa);c.beginPath();c.lineWidth=x;c.strokeStyle=e;c.rect(D-F,Math.min(k,m)-F,A-D+2*F,Math.max(k,m)-Math.min(k,m)+2*F);c.stroke();c.save();0<K&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(N(P,K)),c.strokeStyle=
J,c.lineWidth=K,c.moveTo(D,q-L),c.lineTo(A,q-L),c.stroke());c.restore();c.save();0<O&&(c.beginPath(),c.setLineDash&&c.setLineDash(N(E,O)),c.strokeStyle=T,c.lineWidth=O,c.moveTo(t-$/2<<0,p-ea),c.lineTo(t+$/2<<0,p-ea),c.stroke(),c.moveTo(t-$/2<<0,h+ea),c.lineTo(t+$/2<<0,h+ea),c.stroke());c.restore();w&&(e=Q(R),b.strokeStyle=e,b.lineWidth=Aa,0<Aa&&(b.moveTo(t-F-G,k),b.lineTo(t-F-G,Math.max(h,p)),b.stroke(),b.moveTo(t-F-G,Math.min(h,p)),b.lineTo(t-F-G,m),b.stroke()),aa(b,D,Math.max(k,m),A,Math.min(k,
m),e,0,null,!1,!1,!1,!1),0<O&&(b.beginPath(),b.lineWidth=O,b.moveTo(t+$/2,p-ea),b.lineTo(t-$/2,p-ea),b.stroke(),b.moveTo(t+$/2,h+ea),b.lineTo(t-$/2,h+ea),b.stroke()));(z[l].indexLabel||y.indexLabel||z[l].indexLabelFormatter||y.indexLabelFormatter)&&this._indexLabels.push({chartType:y.type,dataPoint:z[l],dataSeries:y,point:{x:D+(A-D)/2,y:a.axisY.reversed?h:p},direction:1,bounds:{x1:D,y1:Math.min(h,p),x2:A,y2:Math.max(h,p)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,f.height),b.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};n.prototype.renderRangeColumn=
...
a.axisY.convertValueToPixel(g[f].y[0]);t=a.axisY.convertValueToPixel(g[f].y[1]);var n=a.axisX.reversed?b+a.plotType.totalDataSeries*k/2-(a.previousDataSeriesCount+m)*k<<0:b-a.plotType.totalDataSeries*k/2+(a.previousDataSeriesCount+m)*k<<0,v=a.axisX.reversed?n-k<<0:n+k<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>t){var u=l;l=t;t=u}u=q.dataPointIds[f];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:n,y1:l,x2:v,y2:t};aa(c,a.axisX.reversed?
v:n,l,a.axisX.reversed?n:v,t,b,0,b,r,r,!1,!1,q.fillOpacity);b=Q(u);w&&aa(this._eventManager.ghostCtx,a.axisX.reversed?v:n,l,a.axisX.reversed?n:v,t,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:n+(v-n)/2,y:g[f].y[1]>=g[f].y[0]?t:l},direction:g[f].y[1]>=g[f].y[0]?-1:1,bounds:{x1:n,y1:Math.min(l,t),x2:v,y2:Math.max(l,t)},color:b}),this._indexLabels.push({chartType:"rangeColumn",
dataPoint:g[f],dataSeries:q,indexKeyword:1,point:{x:n+(v-n)/2,y:g[f].y[1]>=g[f].y[0]?l:t},direction:g[f].y[1]>=g[f].y[0]?1:-1,bounds:{x1:n,y1:Math.min(l,t),x2:v,y2:Math.max(l,t)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
t=0,h,k,m,p,q,g,r,n=a.axisX.dataInfo.minDiff;isFinite(n)||(n=0.3*Math.abs(a.axisX.range));c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.clip());for(var v=0,u=0;u<this.data.length;u++)!this.data[u].type.match(/(bar|column)/ig)||!this.data[u].visible||this.data[u].type.match(/(stacked)/ig)&&v||v++;for(var y=0;y<
a.dataSeriesIndexes.length;y++){var z=a.dataSeriesIndexes[y],C=this.data[z],D=C.dataPoints,A=s(C._linkedSeries)?!1:C._linkedSeries.type.match(/(bar|column)/ig)&&C._linkedSeries.visible?!0:!1,F=0;if(A)for(e=C._linkedSeries.id,u=0;u<e;u++)!this.data[u].type.match(/(bar|column)/ig)||!this.data[u].visible||this.data[u].type.match(/(stacked)/ig)&&F||(this.data[u].type.match(/(range)/ig)&&(f=!0),F++);e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:
1;t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(A?v:1)))<<0:0.3*this.width;f&&(t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(A?v:1)))<<0:0.03*this.width);u=this.options.dataPointWidth?this.dataPointWidth:0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(n)/Math.log(a.axisX.range):
Math.abs(n)/Math.abs(a.axisX.range))/(A?v:1))<<0;this.dataPointMaxWidth&&e>t&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,t));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&t<e)&&(t=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));u<e&&(u=e);u>t&&(u=t);if(0<D.length)for(var E=C._colorSet,t=0;t<D.length;t++){var e=C.lineColor=C.options.color?C.options.color:E[0],T={color:D[t].whiskerColor?D[t].whiskerColor:D[t].color?C.whiskerColor?C.whiskerColor:D[t].color:
C.whiskerColor?C.whiskerColor:e,thickness:s(D[t].whiskerThickness)?C.whiskerThickness:D[t].whiskerThickness,dashType:D[t].whiskerDashType?D[t].whiskerDashType:C.whiskerDashType,length:s(D[t].whiskerLength)?s(C.options.whiskerLength)?u:C.options.whiskerLength:D[t].whiskerLength,trimLength:s(D[t].whiskerLength)?s(C.options.whiskerLength)?50:0:0};T.length="number"===typeof T.length?0>=T.length?0:T.length>=u?u:T.length:"string"===typeof T.length?parseInt(T.length)*u/100>u?u:parseInt(T.length)*u/100>u:
u;T.thickness="number"===typeof T.thickness?0>T.thickness?0:Math.round(T.thickness):2;var O={color:D[t].stemColor?D[t].stemColor:D[t].color?C.stemColor?C.stemColor:D[t].color:C.stemColor?C.stemColor:e,thickness:D[t].stemThickness?D[t].stemThickness:C.stemThickness,dashType:D[t].stemDashType?D[t].stemDashType:C.stemDashType};O.thickness="number"===typeof O.thickness?0>O.thickness?0:Math.round(O.thickness):2;D[t].getTime?r=D[t].x.getTime():r=D[t].x;if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax)&&
!s(D[t].y)&&D[t].y.length&&"number"===typeof D[t].y[0]&&"number"===typeof D[t].y[1]){var ia=a.axisX.convertValueToPixel(r);b?k=ia:h=ia;ia=a.axisY.convertValueToPixel(D[t].y[0]);b?m=ia:q=ia;ia=a.axisY.convertValueToPixel(D[t].y[1]);b?p=ia:g=ia;b?(q=a.axisX.reversed?k+(A?v:1)*u/2-(A?F-1:0)*u<<0:k-(A?v:1)*u/2+(A?F-1:0)*u<<0,g=a.axisX.reversed?q-u<<0:q+u<<0):(m=a.axisX.reversed?h+(A?v:1)*u/2-(A?F-1:0)*u<<0:h-(A?v:1)*u/2+(A?F-1:0)*u<<0,p=a.axisX.reversed?m-u<<0:m+u<<0);!b&&q>g&&(ia=q,q=g,g=ia);b&&m>p&&
(ia=m,m=p,p=ia);ia=C.dataPointIds[t];this._eventManager.objectMap[ia]={id:ia,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:t,x1:Math.min(m,p),y1:Math.min(q,g),x2:Math.max(p,m),y2:Math.max(g,q),isXYSwapped:b,stemProperties:O,whiskerProperties:T};x(c,Math.min(m,p),Math.min(q,g),Math.max(p,m),Math.max(g,q),e,T,O,b);w&&x(this._eventManager.ghostCtx,m,q,p,g,e,T,O,b);if(D[t].indexLabel||C.indexLabel||D[t].indexLabelFormatter||C.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:D[t],
dataSeries:C,indexKeyword:0,point:{x:b?D[t].y[1]>=D[t].y[0]?m:p:m+(p-m)/2,y:b?q+(g-q)/2:D[t].y[1]>=D[t].y[0]?g:q},direction:D[t].y[1]>=D[t].y[0]?-1:1,bounds:{x1:b?Math.min(m,p):m,y1:b?q:Math.min(q,g),x2:b?Math.max(m,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b}),this._indexLabels.push({chartType:"error",dataPoint:D[t],dataSeries:C,indexKeyword:1,point:{x:b?D[t].y[1]>=D[t].y[0]?p:m:m+(p-m)/2,y:b?q+(g-q)/2:D[t].y[1]>=D[t].y[0]?q:g},direction:D[t].y[1]>=D[t].y[0]?1:-1,bounds:{x1:b?Math.min(m,p):
m,y1:b?q:Math.min(q,g),x2:b?Math.max(m,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(l.x1,l.y1,l.width,l.height),
this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};n.prototype.renderRangeBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,t,h,k,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;l=this.options.dataPointMaxWidth?
...
m<<0:h-a.plotType.totalDataSeries*m/2+(a.previousDataSeriesCount+p)*m<<0;var v=a.axisX.reversed?h-m<<0:h+m<<0;l>t&&(b=l,l=t,t=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];aa(c,l,a.axisX.reversed?v:h,t,a.axisX.reversed?h:v,b,0,null,n,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:h,x2:t,y2:v};b=Q(b);w&&aa(this._eventManager.ghostCtx,l,a.axisX.reversed?v:h,t,a.axisX.reversed?h:v,b,0,
null,!1,!1,!1,!1);if(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:0,point:{x:r[f].y[1]>=r[f].y[0]?l:t,y:h+(v-h)/2},direction:r[f].y[1]>=r[f].y[0]?-1:1,bounds:{x1:Math.min(l,t),y1:h,x2:Math.max(l,t),y2:v},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:1,point:{x:r[f].y[1]>=r[f].y[0]?t:l,y:h+(v-h)/2},direction:r[f].y[1]>=r[f].y[0]?1:
-1,bounds:{x1:Math.min(l,t),y1:h,x2:Math.max(l,t),y2:v},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};n.prototype.renderRangeArea=function(a){function d(){if(y){for(var a=null,c=h.length-1;0<=c;c--)a=h[c],b.lineTo(a.x,a.y2),e.lineTo(a.x,a.y2);b.closePath();b.globalAlpha=m.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<m.lineThickness){b.beginPath();b.moveTo(a.x,a.y2);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y2);b.moveTo(h[0].x,h[0].y1);for(c=0;c<h.length;c++)a=
h[c],b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();b.moveTo(r,n);e.beginPath();e.moveTo(r,n);y={x:r,y:n};h=[];h.push({x:r,y1:n,y2:s})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=[],k=a.dataSeriesIndexes[t],
m=this.data[k],p=m.dataPoints,f=m.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=Q(f);e.fillStyle=f;var f=[],q=!0,g=0,r,n,s,u,y=null;if(0<p.length){var z=m._colorSet[g%m._colorSet.length],v=m.lineColor=m.options.lineColor||z,D=v;b.fillStyle=z;b.strokeStyle=v;b.lineWidth=m.lineThickness;var A="solid";if(b.setLineDash){var x=N(m.nullDataLineDashType,m.lineThickness),A=m.lineDashType,F=N(A,m.lineThickness);b.setLineDash(F)}for(var T=!0;g<p.length;g++)if(u=p[g].x.getTime?
p[g].x.getTime():p[g].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!T)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){r=a.axisX.convertValueToPixel(u);n=a.axisY.convertValueToPixel(p[g].y[0]);s=a.axisY.convertValueToPixel(p[g].y[1]);q||T?(m.connectNullData&&!q?(b.setLineDash&&(m.options.nullDataLineDashType||A===m.lineDashType&&m.lineDashType!==m.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=F,A=m.nullDataLineDashType,
b.setLineDash(x)),b.lineTo(r,n),w&&e.lineTo(r,n),h.push({x:r,y1:n,y2:s})):(b.beginPath(),b.moveTo(r,n),y={x:r,y:n},h=[],h.push({x:r,y1:n,y2:s}),w&&(e.beginPath(),e.moveTo(r,n))),T=q=!1):(b.lineTo(r,n),h.push({x:r,y1:n,y2:s}),w&&e.lineTo(r,n),0==g%250&&d());u=m.dataPointIds[g];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:r,y1:n,y2:s};g<p.length-1&&(D!==(p[g].lineColor||v)||A!==(p[g].lineDashType||m.lineDashType))&&(d(),D=p[g].lineColor||v,h[h.length-
1].newStrokeStyle=D,b.strokeStyle=D,b.setLineDash&&(p[g].lineDashType?(A=p[g].lineDashType,h[h.length-1].newLineDashArray=N(A,m.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(A=m.lineDashType,h[h.length-1].newLineDashArray=F,b.setLineDash(F))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<m.markerSize)){var O=m.getMarkerProperties(g,r,s,b);f.push(O);var E=Q(u);w&&f.push({x:r,y:s,ctx:e,type:O.type,size:O.size,color:E,borderColor:E,borderThickness:O.borderThickness});O=m.getMarkerProperties(g,
r,n,b);f.push(O);E=Q(u);w&&f.push({x:r,y:n,ctx:e,type:O.type,size:O.size,color:E,borderColor:E,borderThickness:O.borderThickness})}if(p[g].indexLabel||m.indexLabel||p[g].indexLabelFormatter||m.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:m,indexKeyword:0,point:{x:r,y:n},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?-1:1,color:z}),this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:m,indexKeyword:1,point:{x:r,y:s},direction:p[g].y[0]>
p[g].y[1]===a.axisY.reversed?1:-1,color:z})}else T||q||d(),T=!0;d();Z.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());
...
this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=a.dataSeriesIndexes[t],k=this.data[h],m=k.dataPoints,f=k.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:h};f=Q(f);e.fillStyle=f;var f=[],p=0,q,
...
typeof m[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(m[p].y[0]);n=a.axisY.convertValueToPixel(m[p].y[1]);var F=k.dataPointIds[p];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:p,x1:q,y1:g,y2:n};s[s.length]={x:q,y:g};x[x.length]={x:q,y:n};p<m.length-1&&(z!==(m[p].lineColor||y)||C!==(m[p].lineDashType||k.lineDashType))&&(z=m[p].lineColor||y,s[s.length-1].newStrokeStyle=z,b.setLineDash&&(m[p].lineDashType?(C=m[p].lineDashType,
s[s.length-1].newLineDashArray=N(C,k.lineThickness)):(C=k.lineDashType,s[s.length-1].newLineDashArray=D)));if(0!==m[p].markerSize&&(0<m[p].markerSize||0<k.markerSize)){var E=k.getMarkerProperties(p,q,g,b);f.push(E);var T=Q(F);w&&f.push({x:q,y:g,ctx:e,type:E.type,size:E.size,color:T,borderColor:T,borderThickness:E.borderThickness});E=k.getMarkerProperties(p,q,n,b);f.push(E);T=Q(F);w&&f.push({x:q,y:n,ctx:e,type:E.type,size:E.size,color:T,borderColor:T,borderThickness:E.borderThickness})}if(m[p].indexLabel||
...
a.dataSeriesIndexes[g],s=this.data[n],v=s.dataPoints,e=s._colorSet[0];s.risingColor=s.options.risingColor?s.options.risingColor:e;s.fallingColor=s.options.fallingColor?s.options.fallingColor:"#e40a0a";var u="number"===typeof s.options.lineThickness?Math.round(s.lineThickness):1,y=1===Math.round(u)%2?-0.5:0;if(0<v.length)for(var z=5<q&&s.bevelEnabled?!0:!1,C=!1,D=null,A=null,l=0;l<v.length;l++)if(v[l].getTime?m=v[l].x.getTime():m=v[l].x,"number"!==typeof v[l].y){if(0<l&&!C&&s.connectNullData)var x=
...
3*Math.PI/2-u&&h.midAngle<3*Math.PI/2+u){if(0===b||g[d].midAngle>h.midAngle)d=e;b++}h.hemisphere=f>Math.PI/2&&f<=3*Math.PI/2?"left":"right";h.indexLabelTextBlock=new ha(n.plotArea.ctx,{fontSize:h.indexLabelFontSize,fontFamily:h.indexLabelFontFamily,fontColor:h.indexLabelFontColor,fontStyle:h.indexLabelFontStyle,fontWeight:h.indexLabelFontWeight,textAlign:h.indexLabelTextAlign,backgroundColor:h.indexLabelBackgroundColor,maxWidth:h.indexLabelMaxWidth,maxHeight:h.indexLabelWrap?5*h.indexLabelFontSize:
...
2,r=t.indexLabelTextBlock.y+t.indexLabelTextBlock.height/2,u=h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2,s=h.indexLabelTextBlock.x+h.indexLabelTextBlock.width,B=h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2;q=t.indexLabelTextBlock.x+t.indexLabelTextBlock.width<h.indexLabelTextBlock.x-p||q>s+p||n>B+p||r<u-p?!1:!0}q?(0>a&&(a=k),l!==a&&(c=l,d+=-C),0===k%Math.max(m.length/10,3)&&(f=!0)):f=!0;f&&(0<d&&0<=a&&0<=c)&&(L(d,a,c),c=a=-1,d=0)}}0<d&&L(d,a,c)})()}}function h(){n.plotArea.layoutManager.reset();
...
"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof u.indexLabelWrap?u.indexLabelWrap:!0;t=u.dataPointIds[A];x._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataPointIndex:A,dataSeriesIndex:0,funnelSection:R[u.reversed?y.length-1-A:A]};"inside"===u.indexLabelPlacement&&(B[A]=A!==ba?u.reversed?R[A].x2-R[A].x1:R[A].x3-R[A].x4:R[A].x3-R[A].x6,20>B[A]&&(B[A]=A!==ba?u.reversed?R[A].x3-R[A].x4:R[A].x2-R[A].x1:R[A].x2-R[A].x1,B[A]/=2));t=b.indexLabelMaxWidth?b.indexLabelMaxWidth:
u.options.indexLabelMaxWidth?u.indexLabelMaxWidth:B[A];if(t>B[A]||0>t)t=B[A];v[A]="inside"===u.indexLabelPlacement?R[A].height:!1;z=x.getPercentAndTotal(u,b);if(u.indexLabelFormatter||b.indexLabelFormatter)C={chart:x.options,dataSeries:u,dataPoint:b,total:z.total,percent:z.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(C):b.indexLabel?x.replaceKeywordsWithValue(b.indexLabel,b,u,A):u.indexLabelFormatter?u.indexLabelFormatter(C):u.indexLabel?x.replaceKeywordsWithValue(u.indexLabel,b,u,A):b.label?
b.label:"";0>=m&&(m=0);1E3>t&&1E3-t<r&&(t+=1E3-t);Q.roundRect||Ba(Q);c=new ha(Q,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:k,fontWeight:h,horizontalAlign:c,textAlign:n,backgroundColor:d,maxWidth:t,maxHeight:!1===v[A]?q?4.28571429*f:1.5*f:v[A],text:b,padding:ca});c.measureText();H.push({textBlock:c,id:u.reversed?D:A,isDirty:!1,lineColor:a,lineThickness:m,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=
[];e=!1;c=0;for(var g,k=J-W-V/2,k=u.options.indexLabelMaxWidth?u.indexLabelMaxWidth>k?k:u.indexLabelMaxWidth:k,l=H.length-1;0<=l;l--){g=y[H[l].id];c=H[l];d=c.textBlock;b=(a=q(l)<R.length?H[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+ca>b.y&&(e=!0);c=g.indexLabelMaxWidth||k;if(c>k||0>c)c=k;f.push(c)}if(e)for(l=H.length-1;0<=l;l--)a=R[l],H[l].textBlock.maxWidth=f[f.length-(l+1)],H[l].textBlock.measureText(),H[l].textBlock.x=J-k,c=H[l].textBlock.height<H[l].textBlock.maxHeight?H[l].textBlock.height:
H[l].textBlock.maxHeight,e=H[l].textBlock.width<H[l].textBlock.maxWidth?H[l].textBlock.width:H[l].textBlock.maxWidth,H[l].height=c,H[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,H[l].textBlock.y=c-H[l].height/2,u.reversed?(H[l].textBlock.y+H[l].height>la+C&&(H[l].textBlock.y=la+C-H[l].height),H[l].textBlock.y<pa-C&&(H[l].textBlock.y=pa-C)):(H[l].textBlock.y<la-C&&(H[l].textBlock.y=la-C),H[l].textBlock.y+H[l].height>pa+C&&(H[l].textBlock.y=pa+C-H[l].height))}function f(){var a,
b,c,d;if("inside"!==u.indexLabelPlacement)for(var e=0;e<R.length;e++)0==H[e].textBlock.text.length?H[e].isDirty=!0:(a=R[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=u.reversed?"undefined"!==typeof a.x5?c>ua?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<ua?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,H[e].textBlock.x=b+V,H[e].textBlock.y=c-H[e].height/2,u.reversed?(H[e].textBlock.y+H[e].height>la+C&&(H[e].textBlock.y=la+C-H[e].height),H[e].textBlock.y<pa-C&&(H[e].textBlock.y=
pa-C)):(H[e].textBlock.y<la-C&&(H[e].textBlock.y=la-C),H[e].textBlock.y+H[e].height>pa+C&&(H[e].textBlock.y=pa+C-H[e].height)));else for(e=0;e<R.length;e++)0==H[e].textBlock.text.length?H[e].isDirty=!0:(a=R[e],b=a.height,c=H[e].height,d=H[e].width,b>=c?(b=e!=ba?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=ba?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,H[e].textBlock.x=b,H[e].textBlock.y=c):H[e].isDirty=!0)}function l(){function a(b,c){var d;if(0>b||b>=H.length)return 0;var e,f=H[b].textBlock;if(0>c){c*=-1;e=
p(b);d=h(e,b);if(d>=c)return f.y-=c,c;if(0==b)return 0<d&&(f.y-=d),d;d+=a(e,-(c-d));0<d&&(f.y-=d);return d}e=q(b);d=h(b,e);if(d>=c)return f.y+=c,c;if(b==R.length-1)return 0<d&&(f.y+=d),d;d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,k;f=(P-K+2*C)/m;k=m;for(var l,h=1;h<k;h++){e=h*f;for(var t=H.length-1;0<=t;t--)!H[t].isDirty&&(H[t].textBlock.y<e&&H[t].textBlock.y+H[t].height>e)&&(l=q(t),!(l>=H.length-1)&&H[t].textBlock.y+H[t].height+ca>H[l].textBlock.y&&(H[t].textBlock.y=H[t].textBlock.y+
H[t].height-e>e-H[t].textBlock.y?e+1:e-H[t].height-1))}for(l=R.length-1;0<l;l--)if(!H[l].isDirty){e=p(l);if(0>e&&(e=0,H[e].isDirty))break;if(H[l].textBlock.y<H[e].textBlock.y+H[e].height){d=d||l;f=l;for(k=0;H[f].textBlock.y<H[e].textBlock.y+H[e].height+ca;){a=a||H[f].textBlock.y+H[f].height;k+=H[f].height;k+=ca;f=e;if(0>=f){f=0;k+=H[f].height;break}e=p(f);if(0>e){f=0;k+=H[f].height;break}}if(f!=l){g=H[f].textBlock.y;a-=g;a=k-a;g=c(a,d,f);break}}}return g}function c(a,b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=
b;d++)e.push(R[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=e[d],f<a)g++,f+=H[b.id].height+ca,H[b.id].textBlock.text="",H[b.id].indexLabelText="",H[b.id].isDirty=!0,H[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,k,l,m=1,n=0;n<2*m;n++){for(var r=H.length-1;0<=r&&!(0<=p(r)&&p(r),f=H[r],g=f.textBlock,l=(k=q(r)<R.length?H[q(r)]:null)?k.textBlock:null,d=+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&(k&&e+d+ca>+l.y.toFixed(6))&&(d=g.y+d+ca-l.y,
e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function h(a,b){return(b<R.length?H[b].textBlock.y:u.reversed?la+C:pa+C)-(0>a?u.reversed?pa-C:la-C:H[a].textBlock.y+H[a].height+ca)}function n(a,b,c){var d,e,g,l=[],h=C,p=[];-1!==b&&(0<=Y.indexOf(b)?(e=Y.indexOf(b),Y.splice(e,1)):(Y.push(b),Y=Y.sort(function(a,b){return a-b})));if(0===Y.length)l=fa;else{e=C*(1!=Y.length||0!=Y[0]&&Y[0]!=R.length-1?2:1)/k();for(var t=0;t<R.length;t++){if(1==Y.length&&0==Y[0]){if(0===t){l.push(fa[t]);d=h;continue}}else 0===
...
b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;ga=!0;d.clearRect(z.x1,z.y1,z.x2-z.x1,z.y2-z.y1);d.fillStyle=a.backgroundColor;d.fillRect(z.x1,z.y1,z.width,z.height);q.changeSection(c,b);var e={};e.dataSeries=u;e.dataPoint=u.reversed?u.dataPoints[y.length-1-b]:u.dataPoints[b];e.index=u.reversed?y.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<R.length;e++)oa(d,R[e],u.fillOpacity);v(d);I&&("inside"!==u.indexLabelPlacement?m(d):f(),r(d));1<=c&&(ga=!1)},null,M.easing.easeOutQuart)}
...
Ga.fNg&&Ga.fNg(x)}var x=this;if(!(0>=a.dataSeriesIndexes.length)){for(var u=this.data[a.dataSeriesIndexes[0]],y=u.dataPoints,z=this.plotArea,C=0.025*z.width,D=0.01*z.width,A=0,F=z.height-2*C,E=Math.min(z.width-2*D,2.8*z.height),I=!1,O=0;O<y.length;O++)if(!I&&("undefined"!==typeof y[O].indexLabel&&null!==y[O].indexLabel&&0<y[O].indexLabel.toString().length)&&(I=!0),!I&&("undefined"!==typeof y[O].label&&null!==y[O].label&&0<y[O].label.toString().length)&&(I=!0),!I&&"function"===typeof u.indexLabelFormatter||
"function"===typeof y[O].indexLabelFormatter)I=!0;I=I||"undefined"!==typeof u.indexLabel&&null!==u.indexLabel&&0<u.indexLabel.toString().length;"inside"!==u.indexLabelPlacement&&I||(D=(z.width-0.75*E)/2);var O=z.x1+D,J=z.x2-D,K=z.y1+C,P=z.y2-C,Q=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=u.length&&(u.dataPoints&&u.visible)&&0!==y.length){var S,G;a=75*E/100;var V=30*(J-a)/100;"funnel"===u.type?(S=s(u.options.neckHeight)?0.35*F:u.neckHeight,G=s(u.options.neckWidth)?0.25*a:u.neckWidth,"string"===
typeof S&&S.match(/%$/)?(S=parseInt(S),S=S*F/100):S=parseInt(S),"string"===typeof G&&G.match(/%$/)?(G=parseInt(G),G=G*a/100):G=parseInt(G),S>F?S=F:0>=S&&(S=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===u.type&&(G=S=0,u.reversed=u.reversed?!1:!0);var D=O+a/2,X=O,W=O+a,la=u.reversed?P:K,L=D-G/2,Z=D+G/2,ua=u.reversed?K+S:P-S,pa=u.reversed?K:P;a=[];var D=[],R=[],E=[],U=K,ba,aa=(ua-la)/(L-X),da=-aa,O="area"===(u.valueRepresents?u.valueRepresents:"height")?c():d();if(-1!==O){if(u.reversed)for(E.push(U),G=O.length-
1;0<G;G--)U+=O[G],E.push(U);else for(G=0;G<O.length;G++)U+=O[G],E.push(U);if(u.reversed)for(G=0;G<O.length;G++)E[G]<ua?(a.push(L),D.push(Z),ba=G):(a.push((E[G]-la+aa*X)/aa),D.push((E[G]-la+da*W)/da));else for(G=0;G<O.length;G++)E[G]<ua?(a.push((E[G]-la+aa*X)/aa),D.push((E[G]-la+da*W)/da),ba=G):(a.push(L),D.push(Z));for(G=0;G<O.length-1;G++)U=u.reversed?y[y.length-1-G].color?y[y.length-1-G].color:u._colorSet[(y.length-1-G)%u._colorSet.length]:y[G].color?y[G].color:u._colorSet[G%u._colorSet.length],
G===ba?R.push({x1:a[G],y1:E[G],x2:D[G],y2:E[G],x3:Z,y3:ua,x4:D[G+1],y4:E[G+1],x5:a[G+1],y5:E[G+1],x6:L,y6:ua,id:G,height:E[G+1]-E[G],color:U}):R.push({x1:a[G],y1:E[G],x2:D[G],y2:E[G],x3:D[G+1],y3:E[G+1],x4:a[G+1],y4:E[G+1],id:G,height:E[G+1]-E[G],color:U});var ca=2,H=[],ga=!1,Y=[],fa=[],O=!1;a=a=0;Ca(Y);for(G=0;G<y.length;G++)y[G].exploded&&(O=!0,u.reversed?Y.push(y.length-1-G):Y.push(G));Q.clearRect(z.x1,z.y1,z.width,z.height);Q.fillStyle=x.backgroundColor;Q.fillRect(z.x1,z.y1,z.width,z.height);
if(I&&u.visible&&(b(),f(),e(),"inside"!==u.indexLabelPlacement)){l();for(G=0;G<y.length;G++)H[G].isDirty||(a=H[G].textBlock.x+H[G].width,a=(J-a)/2,0==G&&(A=a),A>a&&(A=a));for(G=0;G<R.length;G++)R[G].x1+=A,R[G].x2+=A,R[G].x3+=A,R[G].x4+=A,R[G].x5&&(R[G].x5+=A,R[G].x6+=A),H[G].textBlock.x+=A}for(G=0;G<R.length;G++)A=R[G],oa(Q,A,u.fillOpacity),fa.push(A.y1);v(Q);I&&u.visible&&("inside"===u.indexLabelPlacement||x.animationEnabled||m(Q),x.animationEnabled||r());if(!I)for(G=0;G<y.length;G++)A=u.dataPointIds[G],
a={id:A,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:R[u.reversed?y.length-1-G:G]},x._eventManager.objectMap[A]=a;!x.animationEnabled&&O?n(x,-1,0):x.animationEnabled&&!x.animatedRender&&n(x,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ga&&!x.isAnimating&&(s(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=u.reversed?y.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===u.type||"pyramid"===u.type)u.reversed?y[y.length-1-a].exploded=
y[y.length-1-a].exploded?!1:!0:y[a].exploded=y[a].exploded?!1:!0;n(x,b,500)}};return{source:Q,dest:this.plotArea.ctx,animationCallback:function(a,b){M.fadeInAnimation(a,b);1<=a&&(n(x,-1,500),v(x.plotArea.ctx||x.ctx))},easingFunction:M.easing.easeInQuad,animationBase:0}}}}};n.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,
...
d.setAttribute("class","canvasjs-chart-print-frame");J(d,{position:"absolute",width:"100%",border:"0px",margin:"0px 0px 0px 0px",padding:"0px 0px 0px 0px"});d.style.height=this.height+"px";this._canvasJSContainer.appendChild(d);var c=this,b=d.contentWindow||d.contentDocument.document||d.contentDocument;b.document.open();b.document.write('<!DOCTYPE HTML>\n<html><body><img src="'+a+'"/><body/></html>');b.document.body&&b.document.body.style&&(b.document.body.style.margin="0px 0px 0px 0px",b.document.body.style.padding=
...
p.type&&"bubble"!==p.type||!p.markerType?"error"===p.type&&p._linkedSeries?p._linkedSeries.legendMarkerType?p._linkedSeries.legendMarkerType:K.getDefaultLegendMarker(p._linkedSeries.type):K.getDefaultLegendMarker(p.type):p.markerType,g=p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:null}):p.name,r=p.legendMarkerColor=p.legendMarkerColor?p.legendMarkerColor:p.markerColor?p.markerColor:"error"===p.type?s(p.whiskerColor)?
...
markerSize:w,lineColor:p._colorSet[0],dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:v,markerBorderThickness:u};n.push(q)}else for(var y=0;y<p.dataPoints.length;y++){var z=p.dataPoints[y],q=z.legendMarkerType?z.legendMarkerType:p.legendMarkerType?p.legendMarkerType:K.getDefaultLegendMarker(p.type),g=z.legendText?z.legendText:p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:z}):z.name?z.name:"DataPoint: "+
...
2),this.ctx.lineTo(g+0.85*this.lineHeight,r+this.lineHeight/2),this.ctx.stroke(),s-=0.1*this.lineHeight;if("error"===q.chartType){this.ctx.strokeStyle=this.errorMarkerColor[0];this.ctx.lineWidth=f/8;this.ctx.beginPath();var w=g-0.08*this.lineHeight+0.1*this.lineHeight,u=r+0.15*this.lineHeight,v=0.7*this.lineHeight,z=v+0.02*this.lineHeight;this.ctx.moveTo(w,u);this.ctx.lineTo(w+v,u);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(w+v/2,u);this.ctx.lineTo(w+v/2,u+z);this.ctx.stroke();this.ctx.beginPath();
this.ctx.moveTo(w,u+z);this.ctx.lineTo(w+v,u+z);this.ctx.stroke();this.errorMarkerColor.shift()}Z.drawMarker(g+f/2,r+this.lineHeight/2,this.ctx,q.markerType,"error"===q.chartType||"line"===q.chartType||"spline"===q.chartType?q.markerSize/2:q.markerSize,q.markerColor,q.markerBorderColor,q.markerBorderThickness);q.textBlock.x=g+c+f;if("line"===q.chartType||"stepLine"===q.chartType||"spline"===q.chartType)q.textBlock.x+=0.1*this.lineHeight;q.textBlock.y=Math.round(r+this.lineHeight/2);q.textBlock.render(!0);
this.ctx.restore();m=0<p?Math.max(m,q.textBlock.height):q.textBlock.height;this.chart.data[q.dataSeriesIndex].visible||(this.ctx.globalAlpha=1);g=Q(q.id);this.ghostCtx.fillStyle=g;this.ghostCtx.beginPath();this.ghostCtx.fillRect(s,q.textBlock.y-this.lineHeight/2,q.textBlock.x+q.textBlock.width-s,q.textBlock.height);q.x1=this.chart._eventManager.objectMap[q.id].x1=s;q.y1=this.chart._eventManager.objectMap[q.id].y1=q.textBlock.y-this.lineHeight/2;q.x2=this.chart._eventManager.objectMap[q.id].x2=q.textBlock.x+
q.textBlock.width;q.y2=this.chart._eventManager.objectMap[q.id].y2=q.textBlock.y+q.textBlock.height-this.lineHeight/2}h+=m}};ma(K,V);K.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===a||"stackedLine"===a||"bubble"===a||"scatter"===a||"stackedArea"===a||"stackedColumn100"===a||"stackedLine100"===a||"stackedArea100"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===
...
a||"stackedLine100"===a||"stepArea"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===a||"rangeBar"===a||"rangeArea"===a||"rangeSplineArea"===a||"boxAndWhisker"===a||"waterfall"===a)return"square";if("line"===a||"stepLine"===a||"spline"===a||"pie"===a||"doughnut"===a)return"circle";if("area"===a||"splineArea"===a||"stackedArea"===a||"stackedArea100"===a||"funnel"===a||"pyramid"===a)return"triangle";if("error"===a)return"none";window.console.log("Unknown Chart Type: "+a);return null};K.prototype.getDataPointAtX=
...
q.x1&&(a<=q.x2&&d>=q.y1&&d<=q.y2)&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:Math.min(Math.abs(q.x1-a),Math.abs(q.x2-a),Math.abs(q.y1-d),Math.abs(q.y2-d))}),h=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var s=ja("markerSize",g,this)||4,w=c?20:s,r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=w&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=
Math.abs(q.x1-a);q<=n?n=q:0<l?k++:m++;r<=s/2&&(h=!0);break;case "rangeArea":case "rangeSplineArea":s=ja("markerSize",g,this)||4;w=c?20:s;r=Math.min(Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2)),Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y2-d,2)));r<=w&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=Math.abs(q.x1-a);q<=n?n=q:0<l?k++:m++;r<=s/2&&(h=!0);break;case "bubble":s=q.size;r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=s/2&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,
...
2:0)+a+("inside"===this.tickPlacement?0:this.tickLength)+b};F.setLayout=function(a,d,c,b,e,f){var l,h,n,k,m=a[0]?a[0].chart:d[0].chart,p=m.isNavigator?0:10,q=m._axes;if(a&&0<a.length)for(var g=0;g<a.length;g++)a[g]&&a[g].calculateAxisParameters();if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].calculateAxisParameters();if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateAxisParameters();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateAxisParameters();for(g=0;g<q.length;g++)if(q[g]&&q[g].scaleBreaks&&
q[g].scaleBreaks._appliedBreaks.length)for(var r=q[g].scaleBreaks._appliedBreaks,w=0;w<r.length&&!(r[w].startValue>q[g].viewportMaximum);w++)r[w].endValue<q[g].viewportMinimum||(s(q[g].scaleBreaks.firstBreakIndex)&&(q[g].scaleBreaks.firstBreakIndex=w),r[w].startValue>=q[g].viewPortMinimum&&(q[g].scaleBreaks.lastBreakIndex=w));for(var v=w=0,u=0,y=0,z=0,x=0,D=0,A,F,E=h=0,I,O,J,r=I=O=J=!1,g=0;g<q.length;g++)q[g]&&q[g].title&&(q[g]._titleTextBlock=new ha(q[g].ctx,{text:q[g].title,horizontalAlign:"center",
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||s(A)||s(F)||m.isNavigator||m.stockChart)||(h=0,0<a[g].labelAngle?F+u>n&&(h+=0<a[g].labelAngle?F+u-n-Z:0):0>a[g].labelAngle?A-v<l&&A-v<a[g].viewportMinimum&&(E=l-(L+a[g].tickLength+x+A-v+a[g].labelFontSize/2)):0===a[g].labelAngle&&(F+u>n&&(h=F+u/2-n-Z),A-v<l&&A-v<a[g].viewportMinimum&&(E=l-L-a[g].tickLength-x-A+v/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&
0<h?n-=h:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0>a[g].labelAngle&&0<E?l+=E:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0===a[g].labelAngle&&(0<E&&(l+=E),0<h&&(n-=h))),m.panEnabled?U=s(m.sessionVariables.axisX.height)?m.sessionVariables.axisX.height=U:m.sessionVariables.axisX.height:m.sessionVariables.axisX.height=U,h=Math.round(f.y2-U-e+G),k=Math.round(f.y2),a[g].lineCoordinates.x2=n,a[g].lineCoordinates.width=n-l,a[g].lineCoordinates.y1=
h,a[g].lineCoordinates.y2=h+a[g].lineThickness/2,"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.y1=a[g].lineCoordinates.y1+y[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0)-("inside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.y2=a[g].lineCoordinates.y1+a[g].lineThickness/2),a[g].bounds={x1:l,y1:h,x2:n,y2:k-(U+e-y[g]-G),width:n-l,height:k-h}),G+=y[g]+a[g].margin;if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].lineCoordinates.x1=Math.round(f.x1+R+L),d[g].lineCoordinates.x2=
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),m.panEnabled?W=s(m.sessionVariables.axisX2.height)?m.sessionVariables.axisX2.height=W:m.sessionVariables.axisX2.height:m.sessionVariables.axisX2.height=W,h=Math.round(f.y1),k=Math.round(f.y2+d[g].margin),d[g].lineCoordinates.y1=h+W+X-S,d[g].lineCoordinates.y2=h,"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.y1=d[g-1].bounds.y1-z[g]+(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)),d[g].bounds={x1:l,y1:h+(W+
X-z[g]-S),x2:n,y2:k,width:n-l,height:k-h},S+=z[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)L=m.isNavigator?0:10,c[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),L=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:p,h=Math.round(f.y1+W+X<Math.max(L,p)?Math.max(L,p):f.y1+W+X),n=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),L=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/
2:p,k=Math.round(f.y2-U-e-L),c[g].lineCoordinates={x1:l-Q,y1:h,x2:n-Q,y2:k,height:Math.abs(k-h)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g].lineCoordinates.x1-(x[g]-(c[g]._titleTextBlock?c[g]._titleTextBlock.height:0))+("outside"===c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),c[g].bounds={x1:l-(x[g]+Q),y1:h,x2:n,y2:k,width:n-l,height:k-h},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),Q+=x[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),n=Math.round(l),L=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,h=Math.round(f.y1+W+X<Math.max(L,p)?Math.max(L,p):f.y1+W+X),L=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,k=Math.round(f.y2-(U+e+L)),b[g].lineCoordinates=
...
[];A=[];E=[];v=[];F=[];u=[];K=[];for(M=[];4>w;){U=V=S=Q=Y=L=X=e=P=N=G=W=0;if(a&&0<a.length)for(E=[],g=V=0;g<a.length;g++)E.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateWidth():0)),V+=E[g],e+=a[g]&&!m.isNavigator?a[g].margin:0;else E.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));K.push(E);if(d&&0<d.length)for(v=[],g=U=0;g<d.length;g++)v.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateWidth():0)),U+=v[g],X+=d[g]?d[g].margin:0;else v.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():
0));M.push(v);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+V+e),n=Math.round(f.x2-U-X>m.width-10?m.width-10:f.x2-U-X),c[g].labelAutoFit&&!s(y)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,y):0===c[g].labelAngle?Math.max(l,y/2):l),0<!d.length&&(n=0<c[g].labelAngle?n-z/2:0===c[g].labelAngle?n-z/2:n)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=n,c[g].lineCoordinates.width=Math.abs(n-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+V+e),n=Math.round(f.x2-U-X>b[g].chart.width-10?b[g].chart.width-10:f.x2-U-X),b[g]&&b[g].labelAutoFit&&!s(x)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,x):0===b[g].labelAngle?Math.max(l,x/2):l),0<!d.length&&(n-=D/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=n,b[g].lineCoordinates.width=Math.abs(n-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=
0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width);if(c&&0<c.length)for(p=[],g=Q=0;g<c.length;g++)p.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateHeight():0)),Q+=p[g]+c[g].margin,L+=c[g].margin;else p.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateHeight():0));F.push(p);if(b&&0<b.length)for(A=[],g=S=0;g<b.length;g++)A.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateHeight():0)),S+=A[g],Y+=b[g].margin;else A.push(Math.ceil(b[0]?
...
2:0;l=Math.round(f.x1+e);h=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<Math.max(L,10)?Math.max(L,10):f.y1):f.y1<Math.max(L,10)?Math.max(L,10):f.y1;n=Math.round(f.x1+V+e);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-Q>m.height-Math.max(L,10)?m.height-Math.max(L,10):f.y2-Q):f.y2>m.height-Math.max(L,10)?m.height-Math.max(L,10):f.y2;if(c&&0<c.length)for(L=0;L<c.length;L++)c[L]&&c[L].labelAutoFit&&(n=0>c[L].labelAngle?Math.max(n,y):0===c[L].labelAngle?Math.max(n,y/2):n,l=
0>c[L].labelAngle||0===c[L].labelAngle?n-V:l);if(b&&0<b.length)for(L=0;L<b.length;L++)b[L]&&b[L].labelAutoFit&&(n=b[L].lineCoordinates.x1,l=n-V);a[g].lineCoordinates={x1:n-N,y1:h,x2:n-N,y2:k,height:Math.abs(k-h)};"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.x1=a[g].lineCoordinates.x1-(E[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0))+("outside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.x2=a[g].lineCoordinates.x1+a[g].lineThickness/2);a[g].bounds={x1:n-(E[g]+
N),y1:h,x2:n,y2:k,width:n-l,height:k-h};a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.height?a[g].titleMaxWidth:a[g].lineCoordinates.height);a[g].calculateValueToPixelConversionParameters();a[g].calculateBreaksSizeInValues();N+=E[g]+a[g].margin}if(d&&0<d.length)for(g=0;g<d.length;g++){L=d[g]._labels&&0<d[g]._labels.length?d[g]._labels[0].textBlock.fontSize/2:0;l=Math.round(f.x1-e);h=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<
Math.max(L,10)?Math.max(L,10):f.y1):f.y1<Math.max(L,10)?Math.max(L,10):f.y1;n=Math.round(f.x2-U-X);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-Q>m.height-Math.max(L,10)?m.height-Math.max(L,10):f.y2-Q):f.y2>m.height-Math.max(L,10)?m.height-Math.max(L,10):f.y2;if(c&&0<c.length)for(L=0;L<c.length;L++)c[L]&&c[L].labelAutoFit&&(n=0>c[L].labelAngle?Math.max(n,y):0===c[L].labelAngle?Math.max(n,y/2):n,l=0>c[L].labelAngle||0===c[L].labelAngle?n-U:l);if(b&&0<b.length)for(L=0;L<b.length;L++)b[L]&&
b[L].labelAutoFit&&(n=b[L].lineCoordinates.x2,l=n-U);d[g].lineCoordinates={x1:n+P,y1:h,x2:n+P,y2:k,height:Math.abs(k-h)};"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.x1=d[g].lineCoordinates.x1+(v[g]-(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)-2)-("outside"===d[g].tickPlacement?d[g].tickLength:0),d[g].lineCoordinates.x2=d[g].lineCoordinates.x1+d[g].lineThickness/2);d[g].bounds={x1:d[g].lineCoordinates.x1,y1:h,x2:n+v[g]+P,y2:k,width:n-l,height:k-h};d[g].title&&(d[g]._titleTextBlock.maxWidth=
...
!1;else I=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)O=F[w-1][g]===F[w][g]?!0:!1;else O=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)J=u[w-1][g]===u[w][g]?!0:!1;else J=!0}if(r&&I&&O&&J)break;w++}if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels();if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),
...
2,this.intervalType="month"):b/(3*S.monthDuration)<=a?(this.interval=3,this.intervalType="month"):b/(6*S.monthDuration)<=a?(this.interval=6,this.intervalType="month"):(this.interval=b/(1*S.yearDuration)<=a?1:b/(2*S.yearDuration)<=a?2:b/(4*S.yearDuration)<=a?4:Math.floor(F.getNiceNumber(b/(a-1),!0)/S.yearDuration),this.intervalType="year"));if(null===this.viewportMinimum||isNaN(this.viewportMinimum))this.viewportMinimum=e-l/2;if(null===this.viewportMaximum||isNaN(this.viewportMaximum))this.viewportMaximum=
...
F.prototype.getLabelStartPoint=function(){var a=S[this.intervalType+"Duration"]*this.interval,a=new Date(Math.floor(this.viewportMinimum/a)*a);if("millisecond"!==this.intervalType)if("second"===this.intervalType)0<a.getMilliseconds()&&(a.setSeconds(a.getSeconds()+1),a.setMilliseconds(0));else if("minute"===this.intervalType){if(0<a.getSeconds()||0<a.getMilliseconds())a.setMinutes(a.getMinutes()+1),a.setSeconds(0),a.setMilliseconds(0)}else if("hour"===this.intervalType){if(0<a.getMinutes()||0<a.getSeconds()||
...
this.lineColor;this.ctx.fillStyle=this.color;this.ctx.beginPath();this.ctx.globalAlpha=1;Q(this.id);var f,h,n,s,k,m;a=Math.max(this.spacing,3);var p=Math.max(0,this.lineThickness);this.ctx.lineWidth=p;this.ctx.setLineDash&&this.ctx.setLineDash(N(this.lineDashType,p));if("bottom"===this.scaleBreaks.parent._position||"top"===this.scaleBreaks.parent._position)if(b=1===p%2?(b.x<<0)+0.5:b.x<<0,h=1===p%2?(e.x<<0)+0.5:e.x<<0,"top"===this.scaleBreaks.parent._position?(e=this.chart.plotArea.y1,n=this.chart.plotArea.y2+
...
k+a,s+f*a,k+2*a,s,k+3*a);s=h;f*=-1;this.ctx.lineTo(s,k);for(q=0;q<m;q++)this.ctx.bezierCurveTo(s+f*a,k-a,s+f*a,k-2*a,s,k-3*a),k-=3*a,f*=-1}else{if("zigzag"===this.type){f=-1;k=e+a;s=b+a;m=(n-k)/a/2;for(q=0;q<m;q++)this.ctx.lineTo(s,k),s+=2*f*a,k+=2*a,f*=-1;this.ctx.lineTo(s,k);s+=h-b;for(q=0;q<m+1;q++)this.ctx.lineTo(s,k),s+=2*f*a,k-=2*a,f*=-1;this.ctx.lineTo(s+f*a,k+a)}}else if("left"===this.scaleBreaks.parent._position||"right"===this.scaleBreaks.parent._position)if(e=1===p%2?(e.y<<0)+0.5:e.y<<
0,n=1===p%2?(b.y<<0)+0.5:b.y<<0,"left"===this.scaleBreaks.parent._position?(b=this.chart.plotArea.x1,h=this.chart.plotArea.x2+p/2+0.5<<0):(b=this.chart.plotArea.x2,h=this.chart.plotArea.x1-p/2+0.5<<0,a*=-1),this.bounds={x1:b,y1:e-p/2,x2:h,y2:n+p/2},this.ctx.moveTo(b,e),"straight"===this.type||"left"===this.scaleBreaks.parent._position&&0>=a||"right"===this.scaleBreaks.parent._position&&0<=a)this.ctx.lineTo(h,e),this.ctx.lineTo(h,n),this.ctx.lineTo(b,n);else if("wavy"===this.type){s=b;k=e;f=0.5;m=
(h-s)/a/3;for(q=0;q<m;q++)this.ctx.bezierCurveTo(s+a,k+f*a,s+2*a,k+f*a,s+3*a,k),s+=3*a,f*=-1;this.ctx.bezierCurveTo(s+a,k+f*a,s+2*a,k+f*a,s+3*a,k);k=n;f*=-1;this.ctx.lineTo(s,k);for(q=0;q<m;q++)this.ctx.bezierCurveTo(s-a,k+f*a,s-2*a,k+f*a,s-3*a,k),s-=3*a,f*=-1}else if("zigzag"===this.type){f=1;k=e-a;s=b+a;m=(h-s)/a/2;for(q=0;q<m;q++)this.ctx.lineTo(s,k),k+=2*f*a,s+=2*a,f*=-1;this.ctx.lineTo(s,k);k+=n-e;for(q=0;q<m+1;q++)this.ctx.lineTo(s,k),k+=2*f*a,s-=2*a,f*=-1;this.ctx.lineTo(s+a,k+f*a)}0<p&&this.ctx.stroke();
this.ctx.closePath();this.ctx.globalAlpha=this.fillOpacity;this.ctx.globalCompositeOperation="destination-over";this.ctx.fill();this.ctx.restore();this.ctx.globalAlpha=c;this.ctx=d}};ma(P,V);P.prototype.createUserOptions=function(a){if("undefined"!==typeof a||this.options._isPlaceholder){var d=0;this.parent.options._isPlaceholder&&this.parent.createUserOptions();this.options._isPlaceholder||(Ca(this.parent.stripLines),d=this.parent.options.stripLines.indexOf(this.options));this.options="undefined"===
...
(c=!0));this.chart.toolTip&&this.chart.toolTip._entries&&this.chart.toolTip.highlightObjects(this.chart.toolTip._entries);return c};U.prototype.hide=function(){this.chart.resetOverlayedCanvas();this.chart.renderCrosshairs(this.parent);this._hidden=!0};U.prototype.render=function(a,d,c){var b,e,f,h,n=null,w=null,k=null,m="";if(!this.valueFormatString)if("dateTime"===this.parent.valueType)this.valueFormatString=this.parent.valueFormatString;else{var p=0,p="xySwapped"===this.chart.plotInfo.axisPlacement?
...
0,m=[];if("xySwapped"===this.chart.plotInfo.axisPlacement){var v=null;if("bottom"===this.parent._position||"top"===this.parent._position)r=this.parent.dataSeries[0].axisX.convertPixelToValue({y:d});else if("left"===this.parent._position||"right"===this.parent._position)r=this.parent.convertPixelToValue({y:d});for(var x=0;x<this.parent.dataSeries.length;x++)(v=this.parent.dataSeries[x].getDataPointAtX(r,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[x],null!==v.dataPoint.y&&v.dataSeries.visible&&
m.push(v));v=null;if(0===m.length)return;m.sort(function(a,b){return a.distance-b.distance});v=Math.abs(a-this.parent.convertValueToPixel(m[0].dataPoint.y));x=0;if("rangeBar"===m[0].dataSeries.type||"error"===m[0].dataSeries.type)for(var v=Math.abs(a-this.parent.convertValueToPixel(m[x].dataPoint.y[0])),u=0,r=0;r<m.length;r++)if(m[r].dataPoint.y&&m[r].dataPoint.y.length)for(var y=0;y<m[r].dataPoint.y.length;y++)u=Math.abs(a-this.parent.convertValueToPixel(m[r].dataPoint.y[y])),u<v&&(v=u,x=r);else u=
Math.abs(a-this.parent.convertValueToPixel(m[r].dataPoint.y)),u<v&&(v=u,x=r);else if("stackedBar"===m[0].dataSeries.type)for(var v=Math.abs(a-this.parent.convertValueToPixel(m[0].dataPoint.y)),z=u=0,r=x=0;r<m.length;r++)if(m[r].dataPoint.y&&m[r].dataPoint.y.length)for(y=0;y<m[r].dataPoint.y.length;y++)u=Math.abs(a-this.parent.convertValueToPixel(m[r].dataPoint.y[y])),u<v&&(v=u,x=r);else z+=m[r].dataPoint.y,u=Math.abs(a-this.parent.convertValueToPixel(z)),u<v&&(v=u,x=r);else if("stackedBar100"===m[0].dataSeries.type)for(var v=
Math.abs(a-this.parent.convertValueToPixel(m[0].dataPoint.y)),C=z=u=0,r=0;r<m.length;r++)if(m[r].dataPoint.y&&m[r].dataPoint.y.length)for(y=0;y<m[r].dataPoint.y.length;y++)u=Math.abs(a-this.parent.convertValueToPixel(m[r].dataPoint.y[y])),u<v&&(v=u,x=r);else z+=m[r].dataPoint.y,C=m[r].dataPoint.x.getTime?m[r].dataPoint.x.getTime():m[r].dataPoint.x,C=100*(z/m[r].dataSeries.plotUnit.dataPointYSums[C]),u=Math.abs(a-this.parent.convertValueToPixel(C)),u<v&&(v=u,x=r);else for(v=Math.abs(a-this.parent.convertValueToPixel(m[0].dataPoint.y)),
r=x=u=0;r<m.length;r++)if(m[r].dataPoint.y&&m[r].dataPoint.y.length)for(y=0;y<m[r].dataPoint.y.length;y++)u=Math.abs(a-this.parent.convertValueToPixel(m[r].dataPoint.y[y])),u<v&&(v=u,x=r);else u=Math.abs(a-this.parent.convertValueToPixel(m[r].dataPoint.y)),u<v&&(v=u,x=r);y=m[x];if("bottom"===this.parent._position||"top"===this.parent._position){b=0;if("rangeBar"===this.parent.dataSeries[x].type||"error"===this.parent.dataSeries[x].type){v=Math.abs(a-this.parent.convertValueToPixel(y.dataPoint.y[0]));
for(r=u=0;r<y.dataPoint.y.length;r++)u=Math.abs(a-this.parent.convertValueToPixel(y.dataPoint.y[r])),u<v&&(v=u,b=r);n=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.y[b])<<0;this.value=y.dataPoint.y[b];k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y[b]}):s(this.options.label)?da(c?c:y.dataPoint.y[b],this.valueFormatString,this.chart._cultureInfo):
this.label}else if("stackedBar"===this.parent.dataSeries[x].type){v=Math.abs(a-this.parent.convertValueToPixel(m[0].dataPoint.y));z=u=0;for(r=x;0<=r;r--)z+=m[r].dataPoint.y,u=Math.abs(a-this.parent.convertValueToPixel(z)),u<v&&(v=u,b=r);n=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<0)+0.5:this.parent.convertValueToPixel(z)<<0;this.value=z;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y}):s(this.options.label)?
da(c?c:y.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[x].type){v=Math.abs(a-this.parent.convertValueToPixel(m[0].dataPoint.y));C=z=u=0;for(r=x;0<=r;r--)z+=m[r].dataPoint.y,C=m[r].dataPoint.x.getTime?m[r].dataPoint.x.getTime():m[r].dataPoint.x,C=100*(z/m[r].dataSeries.plotUnit.dataPointYSums[C]),u=Math.abs(a-this.parent.convertValueToPixel(C)),u<v&&(v=u,b=r);n=1===q.lineWidth%2?(this.parent.convertValueToPixel(C)<<0)+0.5:this.parent.convertValueToPixel(C)<<
0;this.value=C;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:C}):s(this.options.label)?da(c?c:C,this.valueFormatString,this.chart._cultureInfo):this.label}else n=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.y)<<0,this.value=y.dataPoint.y,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y}):
s(this.options.label)?da(c?c:y.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=n;f=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:h};k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2?k.x=this.chart.bounds.x2-k.width:k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1);k.y=this.parent.lineCoordinates.y2+("top"===this.parent._position?-k.height+this.parent.tickLength:k.fontSize/2)+2;k.y+k.height>this.chart.bounds.y2?k.y=
this.chart.bounds.y2-k.height:k.y<this.chart.bounds.y1&&(k.y=this.chart.bounds.y1)}else if("left"===this.parent._position||"right"===this.parent._position){f=h=w=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.x)<<0;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-p/2,x2:e,y2:h+p/2};C=!1;if(this.parent.labels)for(m=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=m)if(this.parent.labels[r])C=
!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),v=null,x=0;x<this.parent.dataSeries.length;x++)(v=this.parent.dataSeries[x].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?za(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?da(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=y.dataPoint.x;k.y=h+k.fontSize/2-k.measureText().height/
2+2;k.y-k.fontSize/2<this.chart.bounds.y1?k.y=this.chart.bounds.y1+k.fontSize/2+2:k.y+k.measureText().height-k.fontSize/2>this.chart.bounds.y2&&(k.y=this.chart.bounds.y2-k.measureText().height+k.fontSize/2);"left"===this.parent._position?k.x=this.parent.lineCoordinates.x2-k.measureText().width:"right"===this.parent._position&&(k.x=this.parent.lineCoordinates.x2)}}else if("bottom"===this.parent._position||"top"===this.parent._position){r=this.parent.convertPixelToValue({x:a});for(x=0;x<this.parent.dataSeries.length;x++)(v=
this.parent.dataSeries[x].getDataPointAtX(r,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[x],null!==v.dataPoint.y&&v.dataSeries.visible&&m.push(v));if(0===m.length)return;m.sort(function(a,b){return a.distance-b.distance});y=m[0];b=e=n=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.x)<<0;f=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:h};C=!1;if(this.parent.labels)for(m=Math.ceil(this.parent.interval),
r=0;r<this.parent.viewportMaximum;r+=m)if(this.parent.labels[r])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({x:a}),v=null,x=0;x<this.parent.dataSeries.length;x++)(v=this.parent.dataSeries[x].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?
k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?za(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?da(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);
this.value=y.dataPoint.x;k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2&&(k.x=this.chart.bounds.x2-k.width);k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1);"bottom"===this.parent._position?k.y=this.parent.lineCoordinates.y2+k.fontSize/2+2:"top"===this.parent._position&&(k.y=this.parent.lineCoordinates.y1-k.height+k.fontSize/2+2)}else if("left"===this.parent._position||"right"===this.parent._position){!s(this.parent.dataSeries)&&0<this.parent.dataSeries.length&&(r=this.parent.dataSeries[0].axisX.convertPixelToValue({x:a}));
for(x=0;x<this.parent.dataSeries.length;x++)(v=this.parent.dataSeries[x].getDataPointAtX(r,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[x],null!==v.dataPoint.y&&v.dataSeries.visible&&m.push(v));if(0===m.length)return;m.sort(function(a,b){return a.distance-b.distance});x=0;if("rangeColumn"===m[0].dataSeries.type||"rangeArea"===m[0].dataSeries.type||"error"===m[0].dataSeries.type||"rangeSplineArea"===m[0].dataSeries.type||"candlestick"===m[0].dataSeries.type||"ohlc"===m[0].dataSeries.type||
"boxAndWhisker"===m[0].dataSeries.type)for(v=Math.abs(d-this.parent.convertValueToPixel(m[0].dataPoint.y[0])),r=u=0;r<m.length;r++)if(m[r].dataPoint.y&&m[r].dataPoint.y.length)for(y=0;y<m[r].dataPoint.y.length;y++)u=Math.abs(d-this.parent.convertValueToPixel(m[r].dataPoint.y[y])),u<v&&(v=u,x=r);else u=Math.abs(d-this.parent.convertValueToPixel(m[r].dataPoint.y)),u<v&&(v=u,x=r);else if("stackedColumn"===m[0].dataSeries.type||"stackedArea"===m[0].dataSeries.type)for(v=Math.abs(d-this.parent.convertValueToPixel(m[0].dataPoint.y)),
r=z=u=0;r<m.length;r++)if(m[r].dataPoint.y&&m[r].dataPoint.y.length)for(y=0;y<m[r].dataPoint.y.length;y++)u=Math.abs(d-this.parent.convertValueToPixel(m[r].dataPoint.y[y])),u<v&&(v=u,x=r);else z+=m[r].dataPoint.y,u=Math.abs(d-this.parent.convertValueToPixel(z)),u<v&&(v=u,x=r);else if("stackedColumn100"===m[0].dataSeries.type||"stackedArea100"===m[0].dataSeries.type)for(v=Math.abs(d-this.parent.convertValueToPixel(m[0].dataPoint.y)),r=C=z=u=0;r<m.length;r++)if(m[r].dataPoint.y&&m[r].dataPoint.y.length)for(y=
0;y<m[r].dataPoint.y.length;y++)u=Math.abs(d-this.parent.convertValueToPixel(m[r].dataPoint.y[y])),u<v&&(v=u,x=r);else z+=m[r].dataPoint.y,C=m[r].dataPoint.x.getTime?m[r].dataPoint.x.getTime():m[r].dataPoint.x,C=100*(z/m[r].dataSeries.plotUnit.dataPointYSums[C]),u=Math.abs(d-this.parent.convertValueToPixel(C)),u<v&&(v=u,x=r);else for(v=Math.abs(d-this.parent.convertValueToPixel(m[0].dataPoint.y)),r=u=0;r<m.length;r++)if(m[r].dataPoint.y&&m[r].dataPoint.y.length)for(y=0;y<m[r].dataPoint.y.length;y++)u=
Math.abs(d-this.parent.convertValueToPixel(m[r].dataPoint.y[y])),u<v&&(v=u,x=r);else u=Math.abs(d-this.parent.convertValueToPixel(m[r].dataPoint.y)),u<v&&(v=u,x=r);y=m[x];b=0;if("rangeColumn"===this.parent.dataSeries[x].type||"rangeArea"===this.parent.dataSeries[x].type||"error"===this.parent.dataSeries[x].type||"rangeSplineArea"===this.parent.dataSeries[x].type||"candlestick"===this.parent.dataSeries[x].type||"ohlc"===this.parent.dataSeries[x].type||"boxAndWhisker"===this.parent.dataSeries[x].type){v=
Math.abs(d-this.parent.convertValueToPixel(y.dataPoint.y[0]));for(r=u=0;r<y.dataPoint.y.length;r++)u=Math.abs(d-this.parent.convertValueToPixel(y.dataPoint.y[r])),u<v&&(v=u,b=r);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.y[b])<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y[b]}):s(this.options.label)?da(c?c:y.dataPoint.y[b],this.valueFormatString,
this.chart._cultureInfo):this.label;this.value=y.dataPoint.y[b]}else if("stackedColumn"===this.parent.dataSeries[x].type||"stackedArea"===this.parent.dataSeries[x].type){v=Math.abs(d-this.parent.convertValueToPixel(m[0].dataPoint.y));z=u=0;for(r=x;0<=r;r--)z+=m[r].dataPoint.y,u=Math.abs(d-this.parent.convertValueToPixel(z)),u<v&&(v=u,b=r);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<0)+0.5:this.parent.convertValueToPixel(z)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y}):s(this.options.label)?da(c?c:y.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=z}else if("stackedColumn100"===this.parent.dataSeries[x].type||"stackedArea100"===this.parent.dataSeries[x].type){v=Math.abs(d-this.parent.convertValueToPixel(m[0].dataPoint.y));z=u=0;for(r=x;0<=r;r--)z+=m[r].dataPoint.y,C=m[r].dataPoint.x.getTime?m[r].dataPoint.x.getTime():m[r].dataPoint.x,C=100*(z/m[r].dataSeries.plotUnit.dataPointYSums[C]),
u=Math.abs(d-this.parent.convertValueToPixel(C)),u<v&&(v=u,b=r);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(C)<<0)+0.5:this.parent.convertValueToPixel(C)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:C}):s(this.options.label)?da(c?c:C,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=C}else"waterfall"===this.parent.dataSeries[x].type?(w=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum)<<
0)+0.5:this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum)<<0,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataSeries.dataPointEOs[y.index].cumulativeSum}):s(this.options.label)?da(c?c:y.dataSeries.dataPointEOs[y.index].cumulativeSum,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=y.dataSeries.dataPointEOs[y.index].cumulativeSum):(w=1===q.lineWidth%2?(s(a)?d:this.parent.convertValueToPixel(y.dataPoint.y)<<
0)+0.5:s(a)?d:this.parent.convertValueToPixel(y.dataPoint.y)<<0,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:y.dataPoint.y}):s(this.options.label)?da(c?c:y.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=y.dataPoint.y);f=h=w;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-p/2,x2:e,y2:h+p/2};k.y=h+k.fontSize/2-k.measureText().height/2+2;k.y-k.fontSize/2<this.chart.bounds.y1?
...
this.parent._position||"right"===this.parent._position){C=!1;if(this.parent.labels)for(m=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=m)if(this.parent.labels[r])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),v=null,x=0;x<this.parent.dataSeries.length;x++)(v=this.parent.dataSeries[x].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):s(this.options.label)?za(c?c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):s(this.options.label)?da(c?c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):this.label);k.y=d+k.fontSize/2-k.measureText().height/2+2;k.y-k.fontSize/2<this.chart.bounds.y1?k.y=this.chart.bounds.y1+k.fontSize/2+2:k.y+k.measureText().height-k.fontSize/2>this.chart.bounds.y2&&(k.y=this.chart.bounds.y2-k.measureText().height+k.fontSize/2);"left"===this.parent._position?k.x=
this.parent.lineCoordinates.x1-k.measureText().width:"right"===this.parent._position&&(k.x=this.parent.lineCoordinates.x2)}else{if("bottom"===this.parent._position||"top"===this.parent._position)k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?da(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label,k.x=b-k.measureText().width/
2,k.x+k.width>this.chart.bounds.x2&&(k.x=this.chart.bounds.x2-k.width),k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1),"bottom"===this.parent._position?k.y=this.parent.lineCoordinates.y2+k.fontSize/2+2:"top"===this.parent._position&&(k.y=this.parent.lineCoordinates.y1-k.height+k.fontSize/2+2)}else if("bottom"===this.parent._position||"top"===this.parent._position){C=!1;m="";if(this.parent.labels)for(m=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=m)if(this.parent.labels[r])C=
!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({x:a}),v=null,x=0;x<this.parent.dataSeries.length;x++)(v=this.parent.dataSeries[x].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?c?c:v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?za(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:0<this.parent.dataSeries.length?this.parent.convertPixelToValue(a):""}):s(this.options.label)?da(c?c:this.parent.convertPixelToValue(a),
...
k.fontSize/2+k.measureText().height>this.chart.bounds.y2&&(k.y=this.chart.bounds.y2-k.height+k.fontSize/2+2);0<p&&(q.moveTo(b,f),q.lineTo(e,h),q.stroke(),this._hidden=!1);q.restore();this.value="bottom"===this.parent._position||"top"===this.parent._position?this.parent.convertPixelToValue(a):this.parent.convertPixelToValue(d)}if("bottom"===this.parent._position||"top"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(n);if("left"===this.parent._position||"right"===this.parent._position)this._updatedValue=
this.parent.convertPixelToValue(w);this._textBlock=k;s(c)||this.renderLabel();q.globalAlpha=g};U.prototype.renderLabel=function(){s(this._textBlock)||(s(this._textBlock.text)||!("number"===typeof this._textBlock.text.valueOf()||0<this._textBlock.text.length)||this._hidden)||this._textBlock.render(!0)};ma(X,V);X.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class",
...
this._updateToolTip(a,d))};X.prototype._updateToolTip=function(a,d,c){c="undefined"===typeof c?!0:c;this.container||this._initialize();this.enabled||this.hide();if(!this.chart.disableToolTip){if("undefined"===typeof a||"undefined"===typeof d){if(isNaN(this._prevX)||isNaN(this._prevY))return;a=this._prevX;d=this._prevY}else this._prevX=a,this._prevY=d;var b=null,e=null,f=[],h=0;if(this.shared&&this.enabled&&"none"!==this.chart.plotInfo.axisPlacement){if("xySwapped"===this.chart.plotInfo.axisPlacement){var n=
...
this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h,c))&&0<=k.index&&(k.dataSeries=this.chart.axisX2[v].dataSeries[b],null!==k.dataPoint.y&&n.push(k));k=null}}else{n=[];if(this.chart.axisX)for(v=0;v<this.chart.axisX.length;v++)for(h=this.chart.axisX[v].convertPixelToValue({x:a}),k=null,b=0;b<this.chart.axisX[v].dataSeries.length;b++)(k=this.chart.axisX[v].dataSeries[b].getDataPointAtX(h,c))&&0<=k.index&&(k.dataSeries=this.chart.axisX[v].dataSeries[b],null!==k.dataPoint.y&&n.push(k));if(this.chart.axisX2)for(v=
0;v<this.chart.axisX2.length;v++)for(h=this.chart.axisX2[v].convertPixelToValue({x:a}),k=null,b=0;b<this.chart.axisX2[v].dataSeries.length;b++)(k=this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h,c))&&0<=k.index&&(k.dataSeries=this.chart.axisX2[v].dataSeries[b],null!==k.dataPoint.y&&n.push(k))}if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});c=n[0];for(b=0;b<n.length;b++)n[b].dataPoint.x.valueOf()===c.dataPoint.x.valueOf()&&f.push(n[b]);n=null}else{if(b=this.chart.getDataPointAtXY(a,
...
"stepArea"!==e.type&&"splineArea"!==e.type&&"stackedArea"!==e.type&&"stackedArea100"!==e.type&&"rangeArea"!==e.type&&"rangeSplineArea"!==e.type&&"candlestick"!==e.type&&"ohlc"!==e.type&&"boxAndWhisker"!==e.type)return;h=e.axisX.convertPixelToValue({x:a});k=e.getDataPointAtX(h,c);s(k)||(k.dataSeries=e,this.currentDataPointIndex=k.index,b=k.dataPoint)}if(!s(k)&&!s(k.dataPoint)&&!s(k.dataPoint.y))if(k.dataSeries.axisY)if(0<k.dataPoint.y.length){for(b=c=0;b<k.dataPoint.y.length;b++)k.dataPoint.y[b]<k.dataSeries.axisY.viewportMinimum?
...
content:c,entries:d};this._entries=f;this.dispatchEvent("updated",d,this)}}else this.hide(),this.enabled&&this.dispatchEvent("hidden",{chart:this.chart,toolTip:this},this)}};X.prototype.highlightObjects=function(a){var d=this.chart.overlaidCanvasCtx;if(s(this.chart.clearedOverlayedCanvas)||"toolTip"===this.chart.clearedOverlayedCanvas)this.chart.resetOverlayedCanvas(),d.clearRect(0,0,this.chart.width,this.chart.height),this.chart.clearedOverlayedCanvas="toolTip";d.save();var c=this.chart.plotArea,
...
f.borderThickness=f.borderThickness||Math.ceil(0.1*f.size),Z.drawMarkers([f]))):"bubble"===b.type?(f=b.getMarkerProperties(h,e.x1,e.y1,this.chart.overlaidCanvasCtx),f.size=e.size,f.color="white",f.borderColor="white",d.globalAlpha=0.3,Z.drawMarkers([f]),d.globalAlpha=1):"column"===b.type||"stackedColumn"===b.type||"stackedColumn100"===b.type||"bar"===b.type||"rangeBar"===b.type||"stackedBar"===b.type||"stackedBar100"===b.type||"rangeColumn"===b.type||"waterfall"===b.type?aa(d,e.x1,e.y1,e.x2,e.y2,
"white",0,null,!1,!1,!1,!1,0.3):"pie"===b.type||"doughnut"===b.type?Y(d,e.center,e.radius,"white",b.type,e.startAngle,e.endAngle,0.3,e.percentInnerRadius):"funnel"===b.type||"pyramid"===b.type?oa(d,e.funnelSection,0.3,"white"):"candlestick"===b.type?(d.globalAlpha=1,d.strokeStyle=e.color,d.lineWidth=2*e.borderThickness,b=0===d.lineWidth%2?0:0.5,d.beginPath(),d.moveTo(e.x3-b,Math.min(e.y2,e.y3)),d.lineTo(e.x3-b,Math.min(e.y1,e.y4)),d.stroke(),d.beginPath(),d.moveTo(e.x3-b,Math.max(e.y1,e.y4)),d.lineTo(e.x3-
b,Math.max(e.y2,e.y3)),d.stroke(),aa(d,e.x1,Math.min(e.y1,e.y4),e.x2,Math.max(e.y1,e.y4),"transparent",2*e.borderThickness,e.color,!1,!1,!1,!1),d.globalAlpha=1):"ohlc"===b.type?(d.globalAlpha=1,d.strokeStyle=e.color,d.lineWidth=2*e.borderThickness,b=0===d.lineWidth%2?0:0.5,d.beginPath(),d.moveTo(e.x3-b,e.y2),d.lineTo(e.x3-b,e.y3),d.stroke(),d.beginPath(),d.moveTo(e.x3,e.y1),d.lineTo(e.x1,e.y1),d.stroke(),d.beginPath(),d.moveTo(e.x3,e.y4),d.lineTo(e.x2,e.y4),d.stroke(),d.globalAlpha=1):"boxAndWhisker"===
b.type?(d.save(),d.globalAlpha=1,d.strokeStyle=e.stemColor,d.lineWidth=2*e.stemThickness,0<e.stemThickness&&(d.beginPath(),d.moveTo(e.x3,e.y2+e.borderThickness/2),d.lineTo(e.x3,e.y1+e.whiskerThickness/2),d.stroke(),d.beginPath(),d.moveTo(e.x3,e.y4-e.whiskerThickness/2),d.lineTo(e.x3,e.y3-e.borderThickness/2),d.stroke()),d.beginPath(),aa(d,e.x1-e.borderThickness/2,Math.max(e.y2+e.borderThickness/2,e.y3+e.borderThickness/2),e.x2+e.borderThickness/2,Math.min(e.y2-e.borderThickness/2,e.y3-e.borderThickness/
...
a+"s ease-out 0s, bottom "+a+"s ease-out 0s"};ca.prototype.reset=function(){this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=[];this.previousDataPointEventObject=null;this.eventObjects=[];w&&(this.ghostCtx.clearRect(0,0,this.chart.width,this.chart.height),this.ghostCtx.beginPath())};ca.prototype.getNewObjectTrackingId=function(){return++this.lastObjectId};ca.prototype.mouseEventHandler=function(a){if("mousemove"===a.type||"click"===a.type){var d=[],c=Oa(a),b=null;if((b=
...
"cross"===b&&(c.strokeStyle=f,c.lineWidth=e/4,c.beginPath(),c.moveTo(a-e/2,d-e/2),c.lineTo(a+e/2,d+e/2),c.stroke(),c.moveTo(a+e/2,d-e/2),c.lineTo(a-e/2,d+e/2),c.stroke())}},drawMarkers:function(a){for(var d=0;d<a.length;d++){var c=a[d];Z.drawMarker(c.x,c.y,c.ctx,c.type,c.size,c.color,c.borderColor,c.borderThickness)}}};return n}();x.version="v3.6.6 GA";window.CanvasJS&&(x&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=x)})();
