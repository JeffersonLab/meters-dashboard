...
@section('content')
    <p>This page allows you to use archiver data to generate daily statistics for one or more meters over a date range
...
{{--                                    <a href="#chart-modal" class="chart-option" title="show chart as .png"--}}
{{--                                       onclick="showPng()">--}}
...
{{--                                </div>--}}
                    ...
                    <div class="box-body">
                        <div id="chart-mya-stats" class="chart-box-mya-stats"</div>
                    </div>
